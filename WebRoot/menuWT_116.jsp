...
<script type="text/javascript">
    ...
    function openWorkspace(){//
		...
		if((RoleIdx.indexOf(",229,")!=-1)||userId=='1'){
			addTab("","工作桌面","/myehr/jsp/formbuild/TEST_INFO_FORM_116.jsp");
		}else if(RoleIdx.indexOf(",202,")!=-1 ||userId=='18647'){
			addTab("","工作桌面","/myehr/jsp/formbuild/workspace/116/TEST_INFO_FORM_FOR_HR.jsp");
		}else{
			addTab("","工作桌面","/myehr/jsp/formbuild/workspace/116/TEST_INFO_FORM_FOR_EMPLOYEE.jsp");
		}
    }
</script>
</html>
