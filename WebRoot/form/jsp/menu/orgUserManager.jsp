...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/SysMenuList/buildOrgUserTree.action?userId=${param.USERID}",//ajax的请求地址
...
var ORG_ABBREVIATION = node.ORG_ABBREVIATION ? node.ORG_ABBREVIATION.toLowerCase() : "";
	...
	function checkMenus(){
		...
		var checkMenusjson = JSON.stringify(checkMenus);
		var _param={};
    	_param.roleId=userId;
        _param.checkMenus=checkMenus;
		$.ajax({
            url: '/myehr/SysRoleList/saveOrgWithUser.action',
		    type:'post',
