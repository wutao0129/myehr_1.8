...
%>
<link rel="stylesheet" href="${pageContext.request.contextPath }/common/css/commomcssForDrag.css" type="text/css"></link>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/common/js/commonjsForDrag.js"></script>
