RENDERER = {
    ...
    init : function(strategy){
        this.$window = $(window);
        this.$loading = $('<div class="mloading"><div class="mloading-body"><div class="mloading-bar container" id="jsi-particle-container"></div></div></div>');
    ...
    setParameters : function(strategy){     
        ...
        this.$container = this.$loading.find('#jsi-particle-container');
