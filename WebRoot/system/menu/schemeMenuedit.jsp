...
<div class="container-fluid">
	<div style="margin-top:5px;">
		<input id="SYS_SYSTEM_SCHEME_MENU.schemeMenuId" name="schemeMenuId" type="hidden" class="form-control"  style="width:200px;"/>
		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center">员工信息</h3>
			...
			<tr style="height:65px">
				...
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_SYSTEM_SCHEME_MENU.menuCode" name="menuCode" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;"  readonly="true" style="width:200px;"/></td>
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单名称")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_SYSTEM_SCHEME_MENU.menuName" name="menuName" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;"/></td>
			</tr>
		</table>
	</div>
...
$(function () {  
	...
	window.onload=function(){
		...
		document.getElementById("SYS_SYSTEM_SCHEME_MENU.schemeMenuId").value="${param.schemeMenuId}";
		var schemeMenuId = '${param.schemeMenuId}';
		if(schemeMenuId !='' && schemeMenuId!=null){
			_initData(schemeMenuId);
		}
	...
	function save_formemp_emp_edit_click_1881(){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/SysMenuList/saveSysSchemeMenu.action',
			type:'post',
	...
	function _initData(pkId){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/SysMenuList/findSysSchemeMenuById.action?schemeMenuId='+schemeMenuId,
			type:'post',
			//data: JSON.stringify(_param),
			cache: false,
			contentType: 'application/json;charset=utf-8',
