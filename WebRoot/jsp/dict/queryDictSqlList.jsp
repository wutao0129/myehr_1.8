...
<div class="container-fluid" style="height:100%;overflow-y:auto;">
	<div style="margin-top:5px;">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			...
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"重载缓存")%> onclick="refresh()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
...
function addScheme(){
	...
	var content =	"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
					...
					"		<lable style=\"float:left;font-size:12px\">字典编码: </lable>\n"+
					"		<input id=\"dictTypeCode\" name=\"dictTypeCode\" type=\"text\"  required=\"true\" class=\"form-control\"  />\n"+
					"	</div>\n"+
					"</div>\n"+
					"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
					"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
					"		<lable style=\"float:left;font-size:12px\">字典名称: </lable>\n"+
					"		<input id=\"dictTypeName\" name=\"dictTypeName\" type=\"text\"  required=\"true\" class=\"form-control\"  />\n"+
					"	</div>\n"+
					"</div>\n"+
					"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
					"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
					"		<lable style=\"float:left;font-size:12px\">字典类分类: </lable>\n"+
					"		<input id=\"dictTypeClass\" name=\"dictTypeClass\" type=\"text\" readonly value=\"SQL\" class=\"form-control\"  />\n"+
					"	</div>\n"+
					"</div>\n"+
					"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
					"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
					"		<lable style=\"float:left;font-size:12px\">字典关联SQL: </lable>\n"+
					"		<textarea id=\"dictTypeRemark\" name=\"dictTypeRemark\" style=\"resize:none;width:630px;height:100px\" class=\"form-control\"  ></textarea>\n"+
					"	</div>\n"+
					"</div>\n";
	layer.open({
		title:'输入内容',
		...
		yes: function(index, layero){
			...
			if(dictType.dictTypeCode!=""&&dictType.dictTypeCode!=null&&dictType.dictTypeName!=""&&dictType.dictTypeName!=null&&dictType.dictTypeRemark!=""&&dictType.dictTypeRemark!=null&&dictType.dictTypeClass!=""&&dictType.dictTypeClass!=null){
				$.ajax({
					url:'/myehr/dictType/saveDictTypeSql.action',
					type:'POST',
...
function editScheme(){
	var hrs = $("#scheme_list_List").bootstrapTable('getSelections');
	if(hrs.length==1){
		var content =	"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
						"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
						"		<lable style=\"float:left;font-size:12px\">字典编码: </lable>\n"+
						"		<input id=\"dictTypeCode\" name=\"dictTypeCode\" type=\"text\" value=\""+hrs[0].dictTypeCode+"\" required=\"true\" class=\"form-control\"  />\n"+
						"		<input id=\"dictTypeId\" name=\"dictTypeId\" type=\"hidden\" value=\""+hrs[0].dictTypeId+"\" />\n"+
						"	</div>\n"+
						"</div>\n"+
						"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
						"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
						"		<lable style=\"float:left;font-size:12px\">字典名称: </lable>\n"+
						"		<input id=\"dictTypeName\" name=\"dictTypeName\" type=\"text\" value=\""+hrs[0].dictTypeName+"\" required=\"true\" class=\"form-control\"  />\n"+
						"	</div>\n"+
						"</div>\n"+
						"<div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-12\">\n"+
						"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
						...
						"	<div class=\"ui search selection dropdown entitybox field-control\" style=\"display: inline-block;\">\n"+
						"		<lable style=\"float:left;font-size:12px\">字典关联SQL: </lable>\n"+
						"		<textarea id=\"dictTypeRemark\" name=\"dictTypeRemark\" style=\"resize:none;width:630px;height:100px\" class=\"form-control\">"+hrs[0].dictTypeRemark+"</textarea>\n"+
						"	</div>\n"+
						"</div>\n";
		layer.open({
			title:'输入内容',
			...
			yes: function(index, layero){
				...
				dictType.dictTypeRemark = $("#dictTypeRemark").val();
				dictType.dictTypeClass = $("#dictTypeClass").val();
				if(dictType.dictTypeId!=""&&dictType.dictTypeId!=null&&dictType.dictTypeCode!=""&&dictType.dictTypeCode!=null&&dictType.dictTypeName!=""&&dictType.dictTypeName!=null&&dictType.dictTypeRemark!=""&&dictType.dictTypeRemark!=null&&dictType.dictTypeClass!=""&&dictType.dictTypeClass!=null){
					$.ajax({
						url:'/myehr/dictType/saveDictTypeSql.action',
						type:'POST',
						data: JSON.stringify(dictType),
...
function refresh(){
	var selects = $("#scheme_list_List").bootstrapTable('getSelections');
	$.ajax({
		url:'/myehr/dictType/setDictTypeSqlCache.action',
		type:'POST',
		...
		success: function (data) {
			if(data=='false'){
				alert("<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"刷新失败！")%>");
			}else {
				alert("<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"刷新成功")%>");
			}
		}
	});
}
