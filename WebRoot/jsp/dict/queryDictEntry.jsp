...
<div class="input-group">
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			...
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"删除")%> onclick="deleteScheme('delete')"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"恢复")%> onclick="deleteScheme('back')"/>
			</div>
		</div>
		<div style="margin-right:10px;display:inline-block">
...
$(function() {
    ...
    function querys_1041() {
        $("#scheme_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/dictType/queryDictEntryList.action',
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"solutionId\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"方案Id\">"+value+"</a>";
                }
            },
            {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntrySort\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"排序\">"+value+"</a>";
                }
            },
            {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"描述")%>',
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntryRemark\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"描述\">"+value+"</a>";
                }
            },
			{
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictTypeCode\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"字典类编码\">"+value+"</a>";
                }
            },
			{
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictTypeName\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"字典类名称\">"+value+"</a>";
                }
            },
			{
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"父项编码")%>',
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictParentCode\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"父项编码\">"+value+"</a>";
                }
            },
            {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"自定义1")%>',
                field : 'dictEntryCustom1',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntryCustom1\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"自定义1\">"+value+"</a>";
                }
            },
			 {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"自定义2")%>',
                field : 'dictEntryCustom2',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntryCustom2\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"自定义2\">"+value+"</a>";
                }
            },
			 {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"自定义3")%>',
                field : 'dictEntryCustom3',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntryCustom3\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"自定义3\">"+value+"</a>";
                }
            },
			 {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"自定义4")%>',
                field : 'dictEntryCustom4',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntryCustom4\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"自定义4\">"+value+"</a>";
                }
            },
			 {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"自定义5")%>',
                field : 'dictEntryCustom5',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictEntryCustom5\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"自定义5\">"+value+"</a>";
                }
            },
            {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;color:black;width:150px;\" name=\"deleteMark\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"删除标识\">"+value+"</a>";
                }
            },
            ],
...
function editScheme(){
	...
	var url='/myehr/jsp/dict/editDictEntry.jsp?dictEntryId='+select.dictEntryId+'&dictTypeId='+dictTypeId;
...
function deleteScheme(remark){
	...
	if(selects!=null && selects.length>0){
		...
		dictTypeCode = selects[0].dictTypeCode;
	}else {
		alert('<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请选择一行数据")%>');return ;
	}

	var url='${pageContext.request.contextPath }/dictType/deleteDictEntry.action?remark='+remark+'&dictTypeCode='+dictTypeCode+'&dictEntryId='+selectId;
