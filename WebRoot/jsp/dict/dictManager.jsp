...
var setting = {
		...
		var paramtabs_map = {N: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"方案列表")%>', url:'<%= basePath%>jsp/dict/queryDictType.jsp'}],
							F: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"公式列表")%>', url:'<%= basePath%>jsp/dict/queryDictEntry.jsp'}],
							F1: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"公式列表")%>', url:'<%= basePath%>jsp/dict/queryDictEntry.jsp'}],
							SQL:[{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"下拉SQL列表")%>', url:'<%= basePath%>jsp/dict/queryDictSqlList.jsp'}]
							};		
