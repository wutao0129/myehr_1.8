...
<body>
	...
	<div>
		...
		<div class="table" style="width:1100px;float:left;height:600px; " >
			
			 <iframe src="sysUserRole.jsp?" marginwidth="1" marginheight="1" name="iframe" id="iframe"  width="1100" height="600" frameborder="0"></iframe>		
	...
	<script>
		function onNodeClick(){
            ...
            document.getElementById("iframe").setAttribute("src","sysUserRole.jsp?parentCode="+pid);
