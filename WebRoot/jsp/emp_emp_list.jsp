...
$(".fixed-table-container").css("height",$('.container-fluid').height() -99 +"px");
$(".fixed-table-body").css("height","93%");
$(".input-group").css("z-index","7");

    initDict();
    initDate();
    console.log($(".BTNGROUP_2131>div").length);
    var DIVAMOUNT = 5;
...
function initFilterParam(data){
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"ORGVORGANIZATION_ORGCODE\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"组织码\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPID\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"员工ID\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPCODE\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"工号\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CNAME\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"姓名\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_ENAME\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"英文名/拼音\">"+value+"</a>";
                }
            },
            {
...

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_DEPID\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"部门\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark= data_form_24266&realValue="+value+"+\"></a>";
                }
            },
...

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_JOBSTATUS\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"在岗状态\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=Onduty&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPTYPE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"用工类型\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_EMPTYPE&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPKIND\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"员工性质\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_EMPKIND&realValue="+value+"+\"></a>";
                }
            },

  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPGROUP1\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"预留分类1\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPGROUP2\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"预留分类2\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPGROUP3\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"预留分类3\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPGROUP4\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"预留分类4\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPGROUP5\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"预留分类5\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPGRADE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"职级\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_EMPGRADE&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPLEVEL\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"职等\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_EMPGRADE&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_RECTYPE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"招聘来源\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_RECTYPE&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_WORKCITY\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"工作城市\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_WORKCITY&realValue="+value+"+\"></a>";
                }
            },
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_COMPYEARADJUST\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"司龄调整\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_COMPYEARS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"司龄\">"+value+"</a>";
                }
            },
            {
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_WORKYEARADJUST\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"工龄调整\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_WORKYEARS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"工龄\">"+value+"</a>";
                }
            },
            {
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_PROBTERM\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"试用期\">"+value+"</a>";
                }
            },
            {
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_PRACTERM\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"实习期\">"+value+"</a>";
                }
            },
            {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_LEAVETYPE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"离职类型\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_LEAVETYPE&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_LEAVEREASON\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"离职原因\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_LEAVEREASON&realValue="+value+"+\"></a>";
                }
            },

  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_ISBLACKLIST\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"是否离职黑名单\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_COUNTRY\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"国籍\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=Country_Citizenship&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_NATION\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"民族\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_ION&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_ORIGIN\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"籍贯\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=emp_placeOrigin&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CERTTYPE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"证件类型\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=emp_DOCTTYPE&realValue="+value+"+\"></a>";
                }
            },

  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CERTNO\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"证件号码\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_GENDER\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"性别\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=emp_SEX&realValue="+value+"+\"></a>";
                }
            },
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_BIRTHDAYPLACE\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"出生地\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_HOMEADDRESS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"家庭住址\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_RESIDENTTYPE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"户口性质\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=emp_HOUSETYPE&realValue="+value+"+\"></a>";
                }
            },

  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_RESIDENTADDRESS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"户口所在地\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_WORKEMAIL\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"工作邮箱\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_WORKPHONE\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"办公电话\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_PESEMAIL\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"个人邮箱\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_PESPHONE\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"联系电话\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_MOBILE\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"手机号码\">"+value+"</a>";
                }
            },
            {
...

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_HEALTHSTATUS\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"健康状况\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_HEALTHSTATUS&realValue="+value+"+\"></a>";
                }
            },

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_BLOODTYPE\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"血型\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_BLOODTYPE&realValue="+value+"+\"></a>";
                }
            },

  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CHILDSTATUS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"生育状况\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CHILDS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"子女个数\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_QQ\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"QQ\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_WECHART\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"微信\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_YEAROLDS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"年龄\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CONNO\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"合同编号\">"+value+"</a>";
                }
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CONTIMES\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"合同签约次数\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CONTRACTUNIT\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"合同签约单位\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=contactUnit&realValue="+value+"+\"></a>";
                }
            },
...

            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CONTRACTKIND\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"合同性质\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=EMP_CONTRACTKIND&realValue="+value+"+\"></a>";
                }
            },
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CONMONTHS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"合同期限（月）\">"+value+"</a>";
                }
            },
            {
            ...
            },
  {
                ...
                formatter: function (value, row, index) {
                   ...
                   return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_CONSTATUS\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"合同状态\">"+value+"</a>";
                }
            },
            ],
...
function grid_emp_emp_list_fun(pageReqeust){
	...
	if($("[id='FILTER_EMP_V_EMPLOYEE.EMPVEMPLOYEE_CNAME_2131']").attr('multiSelect')){
		...
		_filterdata={EMPVEMPLOYEE_EMPCODE:EMPVEMPLOYEE_EMPCODE,EMPVEMPLOYEE_EMPSTATUS:EMPVEMPLOYEE_EMPSTATUS,EMPVEMPLOYEE_CNAME:EMPVEMPLOYEE_CNAME};
	}
	var paramsMap = {};
	var requestParam={};
