...
<div title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"角色机构树")%>" region="west" style="float:left;overflow:auto;width:200px;height:100%" bodyStyle="overflow:hidden;" showHeader="false" showFilter="false" class="sub-sidebar" allowResize="false">
...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/SysMenuList/buildRoleOrgTree.action?params={s_userId:userId}",//ajax的请求地址
...
var ORG_ABBREVIATION = node.ORG_ABBREVIATION ? node.ORG_ABBREVIATION.toLowerCase() : "";
	...
	function checkMenus(){
		...
		$.ajax({
            url: '/myehr/SysRoleList/saveOrgWithRole.action',
		    type:'post',
