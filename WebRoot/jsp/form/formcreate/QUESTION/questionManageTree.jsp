...
<div id="layout1" class="nui-layout" style="width:100%;height:100%;position:relative">
	<div role="tabpanel" class="tab-pane panel panel-primary fade in active" id="Section1" style="width:17%;float:left;height:93%;margin:0">
		<div class="panel-heading">题库树</div>
...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/form/questionTree.action",//ajax的请求地址
		...
		function onAsyncSuccess(event, treeId, treeNode){
				...
				document.getElementById("main").src = "/myehr/form/toForm.action?formId=3920";
		}
		...
		function onClick(event, treeId, treeNode){  
	    	if(treeNode.isParent==true){
	    		if(treeNode.id=='root'){
	    			...
	    			document.getElementById("main").src="/myehr/form/toForm.action?formId=3925&GROUPID="+treeNode.id;
	    		}
	    		
	    	}else{
	    		document.getElementById("main").src="/myehr/form/toForm.action?formId=3928&XTYPE="+treeNode.id+"&GROUPID="+treeNode.pId;
	    	}
	    	return false;
		}; 
