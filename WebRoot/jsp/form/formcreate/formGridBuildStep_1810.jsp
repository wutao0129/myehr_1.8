                                        ...
                                        <div style="margin:10px 0;">
	                                            ...
	                                            <div class="row cell" id="form1" >
	                                                ...
	                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
															...
															<i style="position:absolute;left:280px;top:5px" onclick="choseColumn()" class="glyphicon glyphicon-plus"></i>
	                                                    </div>
	                                                </div>
	                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                ...
	                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                        <lable style="float:left">不受权限控制</lable>                      
	                                                        <select id="formAuthorityIsControl" title="不受权限控制" styleType="select" name="formAuthorityIsControl"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
	                                                    </div>
	                                                </div>
	                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                        <lable style="float:left">移动端表单</lable>                      
	                                                        <select id="isApp" title="移动端表单" styleType="select" name="isApp"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
	                                                    </div>
	                                                </div>
													 <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                        <lable style="float:left">控制机构权限</lable>                      
	                                                        <select id="isOrgPower" title="控制机构权限" styleType="select" name="isOrgPower"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
	                                                    </div>
	                                                </div>
													 <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                        <lable style="float:left">控制人员权限</lable>                      
	                                                        <select id="isEmpPower" title="控制人员权限" styleType="select" name="isEmpPower"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
	                                                    </div>
	                                                </div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                        <lable style="float:left">是否评论回复</lable>                      
	                                                        <select id="isComment" title="是否评论回复" styleType="select" name="isComment"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
	                                                    </div>
	                                                </div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                        ...
	                                        <div id="form2">
	                                            ...
	                                            <div class="row cell"  >
													...
													<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
														<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
															<lable style="float:left">列表自带按钮</lable>
															<input id="formEditNextOnEnter" name="formEditNextOnEnter" type="text" class="form-control" style="width:200px;" value=""/>
														</div>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
														<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
													...
													<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
														<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
															<lable style="float:left">是否有选择框</lable>
															<input id="formIsCheckbox" name="formIsCheckbox" type="checkbox" checked class="checkbox"/>
														</div>
													</div>
													...
													<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
	                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
	                                                        <lable style="float:left">边框样式</lable>                      
	                                                        <select id="formBorderShowType" title="边框样式" styleType="select" name="formBorderShowType"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="FORM_BORDER_SHOW_TYPE" dataField="dicts"></select>
	                                                    </div>
	                                                </div>
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div id="step2_part2" style="height:45%;padding:10px;display:block;height:88%;">
	                                        	...
	                                        	<div class="row cell" style = "padding-left:15px;width:50%;float:left;">
													<div class="BTNGROUP_55" style="margin:0 auto; display:inline-block;min-height: 20px;" >
														...
														<div style="margin-right:10px;display:inline-block">
														    <input type="button" id="model"  class="btn btn-primary" style="background-color:pink" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"移动端样式编辑")%> onclick="appEdit()"/>
														</div>
													</div>
													<table id="columnList">
													</table>
																...
																<div class="row cell" style="line-height:25px;height:95%;overflow:auto;" >
																	...
																	<div id="columnInfo18" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			...
																			<select id="formColumnType" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"列类型")%>" styleType="select" name="formColumnType"  class="form-control" emptyText="请选择..."  style="width:60%;" textField="dictName" valueField="dictID" DictName="SYS_FORM_COLUMN_TYPE" nullItemText="请选择..." dataField="dict" initParam = "_">
																			</select>
																		</div>
																	</div>
																...
																<div id="lookup" class="row cell" style="border:none;line-height:25px;display:none;height:95%;overflow:auto;" >
																	...
																	<div id="widgetLookupInfo19" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			...
																			<!-- 其他字段 -->
																			<select id="lookupDatabackValue" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"回显值来源")%>" styleType="select" onchange="" name="lookupDatabackValue"  class="form-control" style="width:60%;display:none" DictName="" dataField="sql_form_0000" initParam = "_">
																			</select>
																			<!-- sql调用 -->
																...
																<div id="textLink" class="row cell" style="border:none;line-height:25px;height:95%;overflow:auto;" >
																	...
																	<div id="widgetTextLinkInfo2" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display:none">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			...
																			<input type="button" id="addParamStep2"  class="btn btn-warning" style="float:left" value='参数配置 ' onclick="addLinkParamStep2('COLUMN_TEXTBOX\\|COLUMN_LINK')"/>
																		</div>
																	</div>
																	...
																	<div id="widgetTextLinkInfo4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			...
																			<input id="textboxLinkWinOpenType3" name="textboxLinkWinOpenType" type="radio" onclick="layerJsp()" class="radio" value="3" title = "<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"悬浮增式")%>" style="float:left"/><p style="float:left;width:20%">悬浮增式</p>
																			<input id="textboxLinkWinOpenType4" name="textboxLinkWinOpenType" type="radio" onclick="layerJsp()" class="radio" value="4" title = "<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"悬浮改式")%>" style="float:left"/><p style="float:left;width:20%">悬浮改式</p>
																		</div>
																	</div>
...
$(document).ready(function () {
    $("#form").steps({
        ...
        onFinished: function (event, currentIndex) {
			...
			saveExpandConfig();
			saveFilterExpandConfig();
			saveButtonExpandConfig();
            CloseWebPage();
...
function query_tablestep5() {   
    $("#tableListstep5").bootstrapTable({  
		...
		{  
            ...
            width:55,
            formatter: function (value, row, index) {
            	return "<div style=\"position:relative\"><i class=\"glyphicon glyphicon-plus\" style=\"position: absolute;opacity: 0.5;right: 17px;top: -10px;cursor: pointer;\" onclick=\"layerCacheConfig(this)\"></i><div>" ;
        	}
		}, {  
            title : 'Web显示',  
            field : 'isshowweb',  
            ...
            formatter: function (value, row, index) {
					...
					if(value==undefined){
                    	...
                    	return "<input class=\"checkbox eli w50px\" name=\"isshowweb\" type=\"checkbox\" data-pk=\""+row.Id+"\" data-title=\"Web显示\" "+result+"/>";
                	}
        }, {  
            title : 'Mobile显示',  
            field : 'isshowmobile',  
            ...
            formatter: function (value, row, index) {
					...
					if(value==undefined){
                    	...
                    	return "<input class=\"checkbox eli w50px\" name=\"isshowmobile\" type=\"checkbox\" data-pk=\""+row.Id+"\" data-title=\"Mobile显示\" "+result+"/>";
                	}
        },{
            title : '按钮显示区域',  
            field : 'showArea',  
			...
			formatter: function (value, row, index) {
            	...
            	return "<select id=\"showArea"+index+"\" name=\"showArea\" class=\"form-control\" DictName=\"MOBILE_SHOW_AREA\" data-title=\"按钮显示区域\" value=\""+value+"\"/>" ;
        	}
		},{
            title : '按钮显示类型',  
            field : 'showShow',  
			...
			formatter: function (value, row, index) {
            	...
            	return "<select id=\"showType"+index+"\" name=\"showShow\" class=\"form-control\" DictName=\"MOBILE_SHOW_TYPE\" data-title=\"按钮显示类型\" value=\""+value+"\"/>" ;
        	}
		}],
        onClickRow: function (row, $element) {
	                curRow = row;
	...
	$.ajax({
		...
		success: function (data) {
			...
			if(data.param.formDefIsProcess!=null&&data.param.formDefIsProcess!=""){
				...
				if(data.param.isOrgPower!=null&&data.param.isOrgPower!=""){
					$("#isOrgPower").val(data.param.isOrgPower);
				}else{
					$("#isOrgPower").val("N");
				}
				if(data.param.isEmpPower!=null&&data.param.isEmpPower!=""){
					$("#isEmpPower").val(data.param.isEmpPower);
				}else{
					$("#isEmpPower").val("N");
				}
				if(data.param.isComment!=null&&data.param.isComment!=""){
					$("#isComment").val(data.param.isComment);
				}else{
					$("#isComment").val("N");
				}
				...
				if(data.formGrid!=null){
					...
					if(data.formGrid.formIsCheckbox=="false"){
						$("#formIsCheckbox").prop('checked',false);
					}
					...
					$("#formBorderShowType").val(data.formGrid.formBorderShowType);
				}
...
function saveFormInfo(){
	...
	param.formAuthorityIsControl = $("#formAuthorityIsControl").val();
		...
		if($("#formDefSource").val()!=null){
		param.formDefSource = $("#formDefSource").val();
		}
		param.formDefSql = realSql;
		param.isApp = $("#isApp").val();
		param.isComment = $("#isComment").val();
		param.isEmpPower = $("#isEmpPower").val();
		param.isOrgPower = $("#isOrgPower").val();
...
function changeSql(){
	...
	var content = "";
	$.ajax({
		url:'${pageContext.request.contextPath }/form/getRealSql.action?entitySql='+entitySql.replace(/\+/g, "%2B"),
		type:'post',
		cache: false,
		async: false,
		success: function (data) {
        ...
        {  
            ...
            formatter: function (value, row, index) {
					...
					if(value==undefined){
                    	...
                    	return "<input class=\"checkbox eli w50px\" name=\"defaultsort\" type=\"radio\" data-pk=\""+row.Id+"\" data-title=\"默认排序\" "+result+"/>";
                	}
        }, {  
            title : '可排序',  
            field : 'issort',  
            ...
            formatter: function (value, row, index) {
					...
					if(value==undefined){
                    	...
                    	return "<input class=\"checkbox eli w50px\" name=\"issort\" type=\"checkbox\" data-pk=\""+row.Id+"\" data-title=\"可排序\" "+result+"/>";
                	}
        }, {  
            title : '控件类型',  
...
function mapping(){
	layer.msg('确定要映射？将覆盖原字段', {
		  ...
		  ,yes: function(index){
			...
			$.ajax({
		        url: "${pageContext.request.contextPath }/form/findColumnListSteps_2.action?formDefId=${param.formDefId}&entitySql="+entitySql.replace(/\+/g, "%2B"),
		        type: 'POST',
		        cache: false,
		        async: false,
...
function saveWidget(){
	...
	if(widgetType=='1'){
		...
		if(sysFormTextbox.textboxLinkIsForm=='Y'){
		...
		if($("input[name='textboxLinkWinOpenType']:checked").val()=='1'||$("input[name='textboxLinkWinOpenType']:checked").val()=='3'||$("input[name='textboxLinkWinOpenType']:checked").val()=='4'){
...
function choseColumn(){
	var url = '/myehr/jsp/form/formcreate/formNameColumnList.jsp?formDefId='+${param.formDefId};
	layer.open({
		type: 2,
		title:'选择表单字段',
		shadeClose: true,
