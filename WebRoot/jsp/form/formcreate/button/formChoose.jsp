...
function setUrlParam(url,params){
	...
	function transmit(formID,formName){
		var paramFormId = '${param.paramFormId}';
		var paramFormName = '${param.paramFormName}';
		if(paramFormId!=null && paramFormId!=""){
			window.parent.document.getElementById(paramFormId).value=formID;
			window.parent.document.getElementById(paramFormName).value=formName;
		}else{
			window.parent.document.getElementById("SYS_ICON.buttonFormId").value=formID;
			window.parent.document.getElementById("SYS_ICON.buttonFormName").value=formName;
		}
