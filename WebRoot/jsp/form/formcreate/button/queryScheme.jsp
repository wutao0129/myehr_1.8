	...
	<div style="margin-top:5px;">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"选择")%> onclick="addScheme()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"取消")%> onclick="editScheme()"/>
			</div>
		</div>
...
$(function() {
    ...
    function querys_1041() {
        $("#scheme_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/scheme/querySchemeList.action',
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"solutionCode\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"方案编码\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;color:black;width:150px;\" name=\"solutionName\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"方案名称\">"+value+"</a>";
                }
            },
            {
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"方案分类")%>',
                field : 'solutionParentId',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"solutionParentId\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"方案分类\">"+value+"</a>";
                }
            },
            {
...
function addScheme(){
	...
	$.ajax({
		url:'${pageContext.request.contextPath }/scheme/saveSelectScheme.action',
		type:'post',
...
function editScheme(){
	...
	var url='/myehr/jsp/form/scheme/editScheme.jsp?solutionId='+select.solutionId;
