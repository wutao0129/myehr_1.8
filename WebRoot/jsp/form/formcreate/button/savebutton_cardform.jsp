...
<div class="container-fluid">
	<div style="margin-top:5px;">
		...
		<input id="SYS_ICON.buttonSaveType" name="buttonSaveType" type="hidden" class="form-control" value="1" style="width:200px;"/>
		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center"></h3>
			...
			<tr style="height:65px" id="tr1">
				...
				<td style="padding-left:10px;"  align="left" class="td1" >						<select id="SYS_ICON.buttonSaveSuccessDeal" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"操作成功后处理")%>" name="buttonSaveSuccessDeal"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_FORM_BUTTON_SUCCESS" nullItemText="" dataField="dicts"></select></td>
			</tr>
			<tr id="tr5">
...
<script>
	...
	function initDict(obj){
		for(var i=0;i<classes.length;i++){
			...
			parame.dictData = "SYS_FORM_BUTTON_SAVE_EXC_TYPE,default,fun,approve,free";
			if(type=="true"){
