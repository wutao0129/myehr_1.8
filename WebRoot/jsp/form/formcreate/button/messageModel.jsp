		...
		<div style="border:1px solid #ccc; position:relative;border-radius:5px;margin-bottom:10px">
			...
			<table style="width:98%;table-layout:fixed;" class="cbs-table"  >
				<tr style="height:65px" width="100%">
					<td style="padding-left:10px;"  width="100px"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"消息类型")%>: </lable></td>
					<td style="padding-left:10px;"  align="left" width="200px"  >
						<select id="SYS_SYSTEM_SCHEME.editorMessageType" onchange="changeeSlect2(this)" title="消息类型" name="editorMessageType"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="messageType" nullItemText="" dataField="dicts"></select>
					</td>
...
$(function () {  
	...
	function save_formemp_emp_edit_click_1881(){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/button/saveMessageModel.action',
			type:'post',
