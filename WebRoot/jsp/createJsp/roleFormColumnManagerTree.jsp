...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/SysRoleList/buildRoleFormColumnTreeForCC.action?roleId=${param.roleId}",//ajax的请求地址
		...
		var paramtabs_map = {N: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"表单字段按钮")%>', url:'<%= basePath%>jsp/createJsp/QuestionTemplateTree.jsp'}]};
