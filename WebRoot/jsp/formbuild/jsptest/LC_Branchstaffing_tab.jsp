...
<script type="text/javascript" src="<%=request.getContextPath() %>/jsp/formbuild/TP_management/Xiamenprocess/lc_personnel/LC_Branchstaffing_tab.js"></script>
</head>
<body class="gray-bg" >
...
var EMP_DEPID_session_4091='${sessionScope.EMP_DEPID}';
var JOB_NAME_session_4091='${sessionScope.JOB_NAME}';
var A_NAME_session_4091='${sessionScope.A_NAME}';
var EMP_JOBID_session_4091='${sessionScope.EMP_JOBID}';
var EMP_NAME_session_4091='${sessionScope.EMP_NAME}';
var EMP_EMPID_session_4091='${sessionScope.EMP_EMPID}';
...
var typeLimit = null;
var numLimit = "1";
initFileManage2His('','','','','','fubiao2',numLimit,sizeLimit,typeLimit,'ACT_BUSSINESSID',BUSSINESSID_ACT);
initFileManage2New('','','','','','fubiao2',numLimit,sizeLimit,typeLimit,'ACT_BUSSINESSID',BUSSINESSID_ACT);
changeFileCss();
...
'<div class="row cell">'+
  ...
  '			<input id="PERSONNEL.PERSONNEL_DUTYTIME_4091" name="PERSONNEL_DUTYTIME" type="text" dateType="controls input-append date form_date1" class="form-control" styleType="dateTime" readonly  style="width:200px;float:left;border-radius: 4px 0 0 4px;" format="yyyy-MM-dd" valueformat="yyyy-MM-dd" />'+
  '		</div>'+
  '	</div>'+
'</div>'+
