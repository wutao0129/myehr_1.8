...
<script type="text/javascript" src="Leaveprocess_tab.js"></script></head>
<select onchange="changSize(this)">
...
<h3 class="CCFubiaoTitle CCD_TITLE" >附件</h3><span id="zhankai" class="fa fa-angle-right CCD_TITLE_BUTTON" onclick="changeFunction('fubiao1') " title="展开"></span><span id="xinzeng" class="fa fa-plus-square-o CCD_TITLE_BUTTON" onclick="addFunction('fubiao1')" title="新增"></span>
<!--展示部分-->
...
<div id="remark" name="remark" class="CCFubiao">
...
var EMPCODE_session_4384='';
if('${sessionScope.EMPCODE}'!='null'){EMPCODE_session_4384='${sessionScope.EMPCODE}'}
var EMP_NAME_session_4384='';
if('${sessionScope.EMP_NAME}'!='null'){EMP_NAME_session_4384='${sessionScope.EMP_NAME}'}
var COM_NAME_session_4384='';
if('${sessionScope.COM_NAME}'!='null'){COM_NAME_session_4384='${sessionScope.COM_NAME}'}
var EMP_EMPID_session_4384='';
if('${sessionScope.EMP_EMPID}'!='null'){EMP_EMPID_session_4384='${sessionScope.EMP_EMPID}'}
var COM_COMPID_session_4384='';
if('${sessionScope.COM_COMPID}'!='null'){COM_COMPID_session_4384='${sessionScope.COM_COMPID}'}
var A_NAME_session_4384='';
if('${sessionScope.A_NAME}'!='null'){A_NAME_session_4384='${sessionScope.A_NAME}'}
var JOB_NAME_session_4384='';
if('${sessionScope.JOB_NAME}'!='null'){JOB_NAME_session_4384='${sessionScope.JOB_NAME}'}
var EMP_DEPID_session_4384='';
if('${sessionScope.EMP_DEPID}'!='null'){EMP_DEPID_session_4384='${sessionScope.EMP_DEPID}'}
var EMP_JOBID_session_4384='';
if('${sessionScope.EMP_JOBID}'!='null'){EMP_JOBID_session_4384='${sessionScope.EMP_JOBID}'}
var JOBRANK_session_4384='';
if('${sessionScope.JOBRANK}'!='null'){JOBRANK_session_4384='${sessionScope.JOBRANK}'}
var WORKAGE_session_4384='';
if('${sessionScope.WORKAGE}'!='null'){WORKAGE_session_4384='${sessionScope.WORKAGE}'}
var JOBRANKname_session_4384='';
if('${sessionScope.JOBRANKname}'!='null'){JOBRANKname_session_4384='${sessionScope.JOBRANKname}'}
var amount_session_4384='';
if('${sessionScope.amount}'!='null'){amount_session_4384='${sessionScope.amount}'}
var amountone_session_4384='';
if('${sessionScope.amountone}'!='null'){amountone_session_4384='${sessionScope.amountone}'}
var xvalueone_session_4384='';
if('${sessionScope.xvalueone}'!='null'){xvalueone_session_4384='${sessionScope.xvalueone}'}
var xvalue_session_4384='';
if('${sessionScope.xvalue}'!='null'){xvalue_session_4384='${sessionScope.xvalue}'}
var COMPTYPE_session_4384='';
if('${sessionScope.COMPTYPE}'!='null'){COMPTYPE_session_4384='${sessionScope.COMPTYPE}'}
var businessId_parameter_4384='${param.businessId}';
var JOBGRADE_session_4384='';
if('${sessionScope.JOBGRADE}'!='null'){JOBGRADE_session_4384='${sessionScope.JOBGRADE}'}
var WHELEADER_session_4384='';
if('${sessionScope.WHELEADER}'!='null'){WHELEADER_session_4384='${sessionScope.WHELEADER}'}
...
initFileManage2His('','','','','','fubiao1',numLimit,sizeLimit,typeLimit,'ACT_BUSSINESSID_${param.key}_'+BUSSINESSID_ACT,userId);
initFileManage2New('','','','','','fubiao1',numLimit,sizeLimit,typeLimit,'ACT_BUSSINESSID_${param.key}_'+BUSSINESSID_ACT,userId);
...
if(flowAction=='start'){
LCLEAVE_NCOMPID = COM_NAME_session_4384;
}
var LCLEAVE_EMPID = '';
...
'<h3 class="CCFubiaoTitle CCD_TITLE">基本信息</h3>'+
'<div class="row cell CCM_GROUP">'+
  ...
  '			<label class="CCM_LABEL">工号: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_EMPCODE_4384" name="LCLEAVE_EMPCODE" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_EMPCODE+'" oninput="myFunction(this,\'LCLEAVE_EMPCODE\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">姓名: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_CNAME_4384" name="LCLEAVE_CNAME" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_CNAME+'" oninput="myFunction(this,\'LCLEAVE_CNAME\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">机构: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_NCOMPID_4384" name="LCLEAVE_NCOMPID" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_NCOMPID+'" oninput="myFunction(this,\'LCLEAVE_NCOMPID\')"  emptyText=""  vtype="illegalChar;maxLength:10;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">部门: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_NDEPID_4384" name="LCLEAVE_NDEPID" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_NDEPID+'" oninput="myFunction(this,\'LCLEAVE_NDEPID\')"  emptyText=""  vtype="illegalChar;maxLength:10;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">岗位: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_NJOBID_4384" name="LCLEAVE_NJOBID" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_NJOBID+'" oninput="myFunction(this,\'LCLEAVE_NJOBID\')"  emptyText=""  vtype="illegalChar;maxLength:10;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">工龄: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_WORKAGE_4384" name="LCLEAVE_WORKAGE" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_WORKAGE+'" oninput="myFunction(this,\'LCLEAVE_WORKAGE\')"  emptyText=""  vtype="illegalChar;maxLength:10;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">职务级别: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_JOBRANKNAME_4384" name="LCLEAVE_JOBRANKNAME" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_JOBRANKNAME+'" oninput="myFunction(this,\'LCLEAVE_JOBRANKNAME\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
'</div>'+
'<h3 class="CCFubiaoTitle CCD_TITLE">请假信息</h3>'+
'<div class="row cell CCM_GROUP">'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">结余年休: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_AMOUNT_4384" name="LCLEAVE_AMOUNT" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_AMOUNT+'" oninput="myFunction(this,\'LCLEAVE_AMOUNT\')"  emptyText=""  vtype="illegalChar;maxLength:18;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">结余存休: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_SURPLUSREST_4384" name="LCLEAVE_SURPLUSREST" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_SURPLUSREST+'" oninput="myFunction(this,\'LCLEAVE_SURPLUSREST\')"  emptyText=""  vtype="illegalChar;maxLength:18;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">累计事假: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_ACCUMULATIVE_4384" name="LCLEAVE_ACCUMULATIVE" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_ACCUMULATIVE+'" oninput="myFunction(this,\'LCLEAVE_ACCUMULATIVE\')"  emptyText=""  vtype="illegalChar;maxLength:18;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">累计病假: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_SICKLEAVE_4384" name="LCLEAVE_SICKLEAVE" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+LCLEAVE_SICKLEAVE+'" oninput="myFunction(this,\'LCLEAVE_SICKLEAVE\')"  emptyText=""  vtype="illegalChar;maxLength:18;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">请假类别: </label>'+
  '			<select id="LC_LEAVE.LCLEAVE_LEAVETYPE_4384" title="请假类别" styleType="select" name="LCLEAVE_LEAVETYPE" columnId="84478"  class="form-control CCM_SELECT " emptyText=""  dataField1 = "sql"  required="true"  style="float:left;width:200px;" textField="text" valueField="id" DictName="sql121" dataField="data_form_84478"initParam = "_"></select>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">请假事由: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_REASON_4384" name="LCLEAVE_REASON" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_REASON+'" oninput="myFunction(this,\'LCLEAVE_REASON\')"  vtype="illegalChar;maxLength:200;minLength:null;"  required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">请假开始时间: </label>'+
  ...
  '				<input type="text" readonly class="form-control CCM_DATE_INPUT" dateType="controls input-append date form_date1" id="LC_LEAVE.LCLEAVE_BEGINTIME_4384" styleType="dateTime" value="'+LCLEAVE_BEGINTIME+'"  style="width:134px;" name="LCLEAVE_BEGINTIME"  required="true"  format="yyyy-MM-dd" valueformat="yyyy-MM-dd" />'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">请假结束时间: </label>'+
  '			<div class="controls input-append date form_date1 input-group" data-date=""  data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" style="float:left;width: 134px;">'+
  '				<input type="text" readonly class="form-control CCM_DATE_INPUT" dateType="controls input-append date form_date1" id="LC_LEAVE.LCLEAVE_EMDTIME_4384" styleType="dateTime" value="'+LCLEAVE_EMDTIME+'"  style="width:134px;" name="LCLEAVE_EMDTIME"  required="true"  format="yyyy-MM-dd" valueformat="yyyy-MM-dd" />'+
	'				<span class="input-group-addon" name="closeButton" style="padding:1px 10px 2px 10px;font-size:12px"><span class="glyphicon glyphicon-remove"></span></span>'+
  '				<span class="input-group-addon" name="clickButton" style="padding:1px 10px 2px 10px;font-size:12px"><span class="glyphicon glyphicon-th"></span></span>'+
  '			</div>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">合计天数: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_XVALUE_4384" name="LCLEAVE_XVALUE" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_XVALUE+'" oninput="myFunction(this,\'LCLEAVE_XVALUE\')"  emptyText=""  vtype="illegalChar;maxLength:18;minLength:null;"  onchange="LC_LEAVE_LCLEAVE_XVALUE_valueChange_4384(this)" required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">外出工作单位: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_OUTGOING_4384" name="LCLEAVE_OUTGOING" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_OUTGOING+'" oninput="myFunction(this,\'LCLEAVE_OUTGOING\')"  vtype="illegalChar;maxLength:50;minLength:null;"  required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">联系人: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_CONTACTS_4384" name="LCLEAVE_CONTACTS" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_CONTACTS+'" oninput="myFunction(this,\'LCLEAVE_CONTACTS\')"  vtype="illegalChar;maxLength:50;minLength:null;"  required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">电话: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_PHONE_4384" name="LCLEAVE_PHONE" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_PHONE+'" oninput="myFunction(this,\'LCLEAVE_PHONE\')"  vtype="illegalChar;maxLength:50;minLength:null;"  required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">工作承接人: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_WORKCONTRACTOR_4384" name="LCLEAVE_WORKCONTRACTOR" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_WORKCONTRACTOR+'" oninput="myFunction(this,\'LCLEAVE_WORKCONTRACTOR\')"  vtype="illegalChar;maxLength:50;minLength:null;"  required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">联系电话: </label>'+
  '			<input id="LC_LEAVE.LCLEAVE_CONTACTNYMBER_4384" name="LCLEAVE_CONTACTNYMBER" dataType="text" type="text" class="form-control CCM_INPUT" value="'+LCLEAVE_CONTACTNYMBER+'" oninput="myFunction(this,\'LCLEAVE_CONTACTNYMBER\')"  vtype="illegalChar;maxLength:50;minLength:null;"  required="true"  style="width:200px;height:; "/>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
