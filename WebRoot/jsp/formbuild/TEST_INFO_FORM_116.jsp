...
<div class="container-fluid">
	<div class="row" style="margin-left:0;position:relative" id="TEST_INFO_FORM">
		...
		<div class="col-md-6 col-sm-6 col-lg-6 kuangClass" style="padding-left:0px">
			<div class="row" style="margin-left:0;height:175px;background-color:#FFF;margin-right: 10px;border-radius:10px"  id="">
				<h4 style="font-weight:700;text-align:center;">人事政策</h4>
				<input class="form-control" type="text" style="width:200px;position:absolute;top:10px;right:20px;" placeholder="标题" id="ANNOUNCEMENT_TITLE" onchange="loaddata()"/>
