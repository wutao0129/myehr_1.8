...
function approved_refer_6764(buttonType){
	if(checkedPointRequire()){
		if(buttonType=='通过'){
			...
			approved_refer2_6764(buttonType,'','');
			return;
		}
		layer.open({
			title:'请填写审批意见',
			...
			success: function(layero, index){
				...
				if(buttonType=='驳回'){					$(".layui-m-layercont").css('padding','0 30px 20px 30px');				}			},
...
function approved_refer_6765(buttonType){
	if(checkedPointRequire()){
		if(buttonType=='通过'){
			...
			approved_refer2_6765(buttonType,'','');
			return;
		}
		layer.open({
			title:'请填写审批意见',
...
function temporaryStorage_save_6914(){
	...
	if(checkNull($("#MainElement").find("form"))){
	 ...
	 if(e=='fubiao1'){
		 ...
		 cellObj += '	<span class="fa fa-trash-o deleteButton CCD_DELET_BUTTON" onclick="removeElement('+newElementNum+')"></span>'+
					'	<span class="fa fa-save saveButton CCD_SAVE_BUTTON" onclick="saveElement(this,\'4089\')"></span>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">调配部门: </label>'+
  '			<select id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_NDEPID_4089_add_'+newElementNum+'" title="调配部门" styleType="select" name="PERSONNELASSIGNMENT_ndepid"  columnId="74372" class="form-control selectpicker bla bla bli" data-live-search="true" styleType2="search" emptyText=""  onchange="PERSONNELASSIGNMENT_PERSONNELASSIGNMENT_NDEPID_valueChange_4089(this)" required="true"  style="float:left;width:200px;" dataField1 = "sql"  textField="text" valueField="id" DictName="sql9" dataField="data_form_74372"initParam = "_"></select>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">调配职位: </label>'+
  '			<select id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_NJOBID_4089_add_'+newElementNum+'" title="调配职位" styleType="select" name="PERSONNELASSIGNMENT_njobid"  columnId="74390" class="form-control selectpicker bla bla bli" data-live-search="true" styleType2="search" emptyText=""  style="float:left;width:200px;" dataField1 = "sql"  textField="text" valueField="id" DictName="sql35" dataField="data_form_74390"initParam = "_"></select>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  ...
  '	<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_LNJOBID_4089" name="PERSONNELASSIGNMENT_lnjobid"   type="hidden" >'+
	 ...
	 if(e=='fubiao2'){
		 ...
		 cellObj +=	'<div name="fubiaoElement" class="col-md-12 col-sm-12 col-lg-12" id="newElement'+newElementNum+'">'+
					...
					'<form class="row cell add_element" style="padding-right:50px">';
		 cellObj += '	<span class="fa fa-trash-o deleteButton CCD_DELET_BUTTON" onclick="removeElement('+newElementNum+')"></span>'+
					'	<span class="fa fa-save saveButton CCD_SAVE_BUTTON" onclick="saveElement(this,\'4373\')"></span>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">备注: </label>'+
  '			<textarea id="LC_REMARK.LCREMARK_REMARK_4373_add_'+newElementNum+'" name="LCREMARK_REMARK" class="CCReadTextarea form-control"  vtype="illegalChar;maxLength:100;minLength:null;"  style="width:600px;height:58;"></textarea>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
					'</form>'+
...
PERSONNELASSIGNMENT_LNJOBID = arr[i].PERSONNELASSIGNMENT_LNJOBID;
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">姓名: </label>'+
  '			<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_EMPID_4089" title="姓名" styleType="select" name="PERSONNELASSIGNMENT_EMPID" value="'+PERSONNELASSIGNMENT_EMPID_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="74371" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  onchange="PERSONNELASSIGNMENT_PERSONNELASSIGNMENT_EMPID_valueChange_4089(this)" required="true"  dataField1 = "sql"  readonly  style="width:200px; " textField="text" valueField="id" DictName="sql159" dataField="data_form_74371"initParam = "_"/>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">类型: </label>'+
  '			<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_XTYPE_4089" title="类型" styleType="select" name="PERSONNELASSIGNMENT_XTYPE" value="'+PERSONNELASSIGNMENT_XTYPE_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="74383" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  required="true"  dataField1 = "dict"  readonly  style="width:200px; " showNullItem="true" textField="dictName" valueField="dictId" DictName="XM_XTYPE" nullItemText="" dataField="dicts_form_74383"initParam = "_"/>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">现属支行/部门: </label>'+
  '			<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_XDEPID_4089" title="现属支行/部门" styleType="select" name="PERSONNELASSIGNMENT_XDEPID" value="'+PERSONNELASSIGNMENT_XDEPID_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="74386" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  dataField1 = "sql"  readonly  style="width:200px; " showNullItem="true" textField="text" valueField="id" DictName="sql9" nullItemText="" dataField="data_form_74386"initParam = "_"/>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">现职位: </label>'+
  '			<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_JOBID_4089" title="现职位" styleType="select" name="PERSONNELASSIGNMENT_JOBID" value="'+PERSONNELASSIGNMENT_JOBID_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="74387" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  dataField1 = "sql"  readonly  style="width:200px; " showNullItem="true" textField="text" valueField="id" DictName="jobidSql1" nullItemText="" dataField="data_form_74387"initParam = "_"/>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">调配部门: </label>'+
  '			<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_NDEPID_4089" title="调配部门" styleType="select" name="PERSONNELASSIGNMENT_NDEPID" value="'+PERSONNELASSIGNMENT_NDEPID_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="74372" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  onchange="PERSONNELASSIGNMENT_PERSONNELASSIGNMENT_NDEPID_valueChange_4089(this)" required="true"  dataField1 = "sql"  readonly  style="width:200px; " textField="text" valueField="id" DictName="sql9" dataField="data_form_74372"initParam = "_"/>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">调配职位: </label>'+
  '			<input id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_NJOBID_4089" title="调配职位" styleType="select" name="PERSONNELASSIGNMENT_NJOBID" value="'+PERSONNELASSIGNMENT_NJOBID_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="74390" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  dataField1 = "sql"  readonly  style="width:200px; " textField="text" valueField="id" DictName="sql35" dataField="data_form_74390"initParam = "_"/>'+
...
var njobid_value = xx.find("[name='PERSONNELASSIGNMENT_NJOBID']").eq(1).val();
  ...
  var PERSONNELASSIGNMENT_NDEPID_cellObj = '			<select id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_NDEPID_4089_'+num+'_select" title="调配部门"  styleType="select" name="PERSONNELASSIGNMENT_NDEPID" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff" columnId="74372" class="form-control selectpicker bla bla bli" data-live-search="true" styleType2="search" dataField1 = "sql"  emptyText=""  onchange="PERSONNELASSIGNMENT_PERSONNELASSIGNMENT_NDEPID_valueChange_4089(this)" required="true"  style="float:left;width:200px;" textField="text" valueField="id" DictName="sql9" dataField="data_form_74372"initParam = "_"></select>';
	...
	xx.find("[name='PERSONNELASSIGNMENT_NDEPID']").eq(0).remove();
  var PERSONNELASSIGNMENT_NJOBID_cellObj = '			<select id="PERSONNELASSIGNMENT.PERSONNELASSIGNMENT_NJOBID_4089_'+num+'_select" title="调配职位"  styleType="select" name="PERSONNELASSIGNMENT_NJOBID" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff" columnId="74390" class="form-control selectpicker bla bla bli" data-live-search="true" styleType2="search" dataField1 = "sql"  emptyText=""  style="float:left;width:200px;" textField="text" valueField="id" DictName="sql35" dataField="data_form_74390"initParam = "_"></select>';
