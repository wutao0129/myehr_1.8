...
<script type="text/javascript" src="/myehr/jsp/formbuild/test/LC_Branchstaffing_tab.js"></script>
<script type="text/javascript" src="/myehr/common/js/layer/layer.js"></script></head>
<body class="gray-bg" >
<div class="container-fluid" id="CardAndCardForm" style="height:98%;width:70%;overflow-y: auto;overflow-x:  hidden;padding: 0px;float:left">
	...
	<h3 class="CCFubiaoTitle CCD_TITLE" >变动人员情况</h3><span id="zhankai" class="fa fa-angle-right CCD_TITLE_BUTTON" onclick="changeFunction('fubiao1') " title="展开"></span><span id="xinzeng" class="fa fa-plus-square-o CCD_TITLE_BUTTON" onclick="addFunction('fubiao1')" title="新增"></span>
	<!--展示部分-->
	...
	<h3 class="CCFubiaoTitle CCD_TITLE" >备注</h3><span id="zhankai" class="fa fa-angle-right CCD_TITLE_BUTTON" onclick="changeFunction('fubiao2') " title="展开"></span><span id="xinzeng" class="fa fa-plus-square-o CCD_TITLE_BUTTON" onclick="addFunction('fubiao2')" title="新增"></span>
	<!--展示部分-->
	<div class="row" style="margin-left:0;padding: 0 15px 0 0;margin-bottom:20px;" id="TEST_FEE_INFO_FORM">
	</div>
	<!--展开部分-->
...
<div class="container-fluid" id="editPerson" style="height:98%;width:29%;overflow-y: hidden;overflow-x:hidden;padding:0px;margin-top:1%;float:right;padding-bottom:50px;position:relative;">
	<h3 class="CCFubiaoTitle CCD_TITLE">编辑流程路线</h3>
	<div class="row " style="margin-left:0;padding: 0 15px 0 0;position:relative;" id="lineElement">
	</div>
	<input type="button" class="btn btn-info " onclick="saveActLine()" value="保存" style="position:absolute;bottom:10px;left:50%;-webkit-transform: translate(-50%, -50%);">
</div>
...
initFileManage2His('','','','','','fubiao2',numLimit,sizeLimit,typeLimit,'ACT_BUSSINESSID_${param.key}_'+BUSSINESSID_ACT,userId);
initFileManage2New('','','','','','fubiao2',numLimit,sizeLimit,typeLimit,'ACT_BUSSINESSID_${param.key}_'+BUSSINESSID_ACT,userId);
...
'<h3 class="CCFubiaoTitle CCD_TITLE">申请人信息</h3>'+
'<div class="row cell CCM_GROUP">'+
  ...
  '			<label class="CCM_LABEL">标题: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_TITLE_4091" name="PERSONNEL_TITLE" dataType="text" type="text" class="form-control CCM_INPUT" value="'+PERSONNEL_TITLE+'" oninput="myFunction(this,\'PERSONNEL_TITLE\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  required="true"  style="width:600px;height:30px; "/>'+
  ...
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">申请日期: </label>'+
  ...
  '				<input type="text" readonly class="form-control CCM_DATE_INPUT" dateType="controls input-append date form_date1" id="PERSONNEL.PERSONNEL_DATE_4091" styleType="dateTime" value="'+PERSONNEL_DATE+'"  style="width:134px;" name="PERSONNEL_DATE"  format="yyyy-MM-dd" valueformat="yyyy-MM-dd" />'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">申请人职位: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_JOBIDNAME_4091" name="PERSONNEL_JOBIDNAME" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+PERSONNEL_JOBIDNAME+'" oninput="myFunction(this,\'PERSONNEL_JOBIDNAME\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">申请部门: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_DEPIDNAME_4091" name="PERSONNEL_DEPIDNAME" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+PERSONNEL_DEPIDNAME+'" oninput="myFunction(this,\'PERSONNEL_DEPIDNAME\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">申请人: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_EMPDINAME_4091" name="PERSONNEL_EMPDINAME" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+PERSONNEL_EMPDINAME+'" oninput="myFunction(this,\'PERSONNEL_EMPDINAME\')"  emptyText=""  vtype="illegalChar;maxLength:50;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<input id="PERSONNEL.PERSONNEL_EMPID_4091" name="PERSONNEL_EMPID" value="'+PERSONNEL_EMPID+'"   type="hidden" >'+
'</div>'+
'<h3 class="CCFubiaoTitle CCD_TITLE">调配信息</h3>'+
'<div class="row cell CCM_GROUP">'+
  '	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 CCM_COL_TEXTAREA" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label style="float:left;font-size:14px;width:100px;line-height:25px">原因: </label>'+
  '			<textarea id="PERSONNEL.PERSONNEL_RENSON_4091" name="PERSONNEL_RENSON" class="CCReadTextarea form-control CCM_TEXTAREA"  vtype="illegalChar;maxLength:100;minLength:null;"  required="true"  style="width:600px;height:58px; ">'+PERSONNEL_RENSON+'</textarea>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
'</div>'+
'<h3 class="CCFubiaoTitle CCD_TITLE">审批信息</h3>'+
'<div class="row cell CCM_GROUP">'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">是否行长审批: </label>'+
  '			<select id="PERSONNEL.PERSONNEL_DEPARTMENT_4091" title="是否行长审批" styleType="select" name="PERSONNEL_DEPARTMENT" columnId="78192"  class="form-control CCM_SELECT " emptyText=""  dataField1 = "dict"  required="true"  style="float:left;width:200px;" textField="dictName" valueField="dictId" DictName="ISBLACKLIST" dataField="dicts_form_78192"initParam = "_"></select>'+
  '			<span style="color:red;" class="CC_REQUMARK" > * </span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">调入支行综合经理: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_TRANSFER_4091" title="调入支行综合经理" styleType="select" name="PERSONNEL_TRANSFER" value="'+PERSONNEL_TRANSFER_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="78193" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  dataField1 = "sql"  readonly  style="width:200px; " textField="text" valueField="id" DictName="sql12" dataField="data_form_78193"initParam = "_"/>'+
	'			<input id="PERSONNEL.PERSONNEL_TRANSFER_4091_value" name="PERSONNEL_TRANSFER" type="hidden" value="'+PERSONNEL_TRANSFER+'"/>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">调入部室负责人确认人员到位: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_DEPARTMENTCONFIRMS_4091" title="调入部室负责人确认人员到位" styleType="select" name="PERSONNEL_DEPARTMENTCONFIRMS" value="'+PERSONNEL_DEPARTMENTCONFIRMS_DICTNAME+'" class="form-control CCM_DISABLE_INPUT" columnId="78194" style="width:200px;float:left;height:25px;padding:0;border:none;background-color:#fff"  emptyText=""  dataField1 = "dict"  readonly  style="width:200px; " textField="dictName" valueField="dictId" DictName="Departmentcharge" dataField="dicts_form_78194"initParam = "_"/>'+
  ...
  '	<div class="col-lg-4 col-md-4 col-sm-6  col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">其他-文本: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_OTHERSINGLE_4091" name="PERSONNEL_OTHERSINGLE" dataType="text" type="text" class="form-control CCM_DISABLE_INPUT" value="'+PERSONNEL_OTHERSINGLE+'" oninput="myFunction(this,\'PERSONNEL_OTHERSINGLE\')"  vtype="illegalChar;maxLength:10;minLength:null;"  readonly="true" style="width:200px;height:;"/>'+
  '			<span style="color:red;" class="CC_REQUMARK" ></span>'+
  '		</div>'+
  '	</div>'+
  '	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 CCM_COL" >'+
  '		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
  '			<label class="CCM_LABEL">到岗日期: </label>'+
  '			<input id="PERSONNEL.PERSONNEL_DUTYTIME_4091" name="PERSONNEL_DUTYTIME" type="text" dateType="controls input-append date form_date1" class="form-control CCM_DISABLE_INPUT" value="'+PERSONNEL_DUTYTIME+'" styleType="dateTime" readonly  style="width:200px;" format="yyyy-MM-dd" valueformat="yyyy-MM-dd" />'+
  '		</div>'+
  '	</div>'+
'</div>'+
...
'<div class="BUSSINESS_ID"><h5 class="BUSSINESS_ID_label">流程单据号:</h5><input class="BUSSINESS_ID_value" readonly type="text" id="PERSONNEL.PERSONNEL_BUSINESSID_IS_4091" name="PERSONNEL_BUSINESSID_IS" value="'+PERSONNEL_BUSINESSID_IS+'"/></div>'+
  '	<input id="PERSONNEL.PERSONNEL_FLAG_4091" name="PERSONNEL_FLAG" value="'+PERSONNEL_FLAG+'"   type="hidden" >'+
	...
	$(".mainFormElement").append(cellObj);
		var cellObj1 = '	<div id="main_buttons" style="position:absolute;bottom:0;left:35%;-webkit-transform: translate(-50%, -50%);">';
		if(flowAction=='start'){
...
function showDate_Main2(arr,total,e){
		$(e).css("display","none");$(e).attr("onclick","");
		 var cellObj = '';
		 for (var i = 0; i == 0; i--) {
	...
	cellObj += 	  '<div class="col-md-12 col-sm-12 col-lg-12 CCM_ELEMENT" id="choosePerson" >'+
			      '    <div class="contact-box">'+
				  '		<form class="row cell CCM_ELEMENT_ROW" id="choosePerson0">'+
	...
	elementsListSelectInitFunction('#choosePerson0');//初始化新增下拉控件
}
...
var count=1;
	...
	cellObj += 		'<div class="col-md-12 col-sm-12 col-lg-12 CCM_ELEMENT" id="MainElement" >'+
					...
					'		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
					'			<label class="CCM_LABEL">节点顺序: </label>'+
					'			<input id=\"order_'+count+'\" name="SYSUSER_USER_CODE" type="text" title="节点顺序" class="form-control" vtype="illegalChar;maxLength:50;minLength:null;" style="width:200px;height:; float:left;"/>'+
					'			<span style="color:red;line-height:35px;font-size:27px"></span>'+
					'		</div>'+
					'	</div>'+
					*/
					...
					'		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">'+
					'			<label class="CCM_LABEL">选择审批人: </label>'+
					'			<select id=\"chooseman_'+count+'\" title="选择审批人" styleType="select" name="SYSUSER_OPERATOR_NAME" columnId="47999"  class="form-control CCM_SELECT selectpicker bla bla bli"  data-live-search="true" styleType2="search" emptyText=""  dataField1 = "sql"  required="true"  style="float:left;width:200px;" textField="text" valueField="id" DictName="sql4" dataField="data_form_47999"initParam = "_"></select>'+
					'			<span style="color:red;"> * </span>'+
					'		</div>'+
					'	</div>'+
					'</div>'+
...
function saveFunctions(){
	var save={};
	 //var taskid={param.TaskId};
	  ...
	  //var choose=
	  var url='/myehr/actfree/addactfreeway.action';
         $.ajax({
			url:url,
			type: 'post',
