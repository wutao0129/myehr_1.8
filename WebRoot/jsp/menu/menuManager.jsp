...
<div title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单树")%>" region="west" style="float:left;overflow:auto;width:13%;height:100%" bodyStyle="overflow:hidden;" showHeader="false"
	showFilter="false"
...
var setting = {
		...
		var paramtabs_map = {N: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"机构树")%>', url:'<%= basePath%>jsp/menu/menuList.jsp'}]}		
