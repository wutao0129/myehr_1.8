...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/SysMenuList/buildOrgRoleTree.action?roleId=${param.roleId}",//ajax的请求地址
		...
		function filter(treeId, parentNode, childNodes) {
				if (!childNodes) return null;
					for (var i=0, l=childNodes.length; i<l; i++) {
						childNodes[i].name = childNodes[i].orgAbbreviation.replace(/\.n/g, '.');
					}
					return childNodes;
				}
