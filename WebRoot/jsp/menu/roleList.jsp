    ...
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="addorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"复制角色权限")%> onclick="copyRolePower()"/>
			</div>
		</div>
...
$(function() {
    ...
    function querys_1041() {
        $("#org_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/SysRoleList/queryRoleList.action',
...
function copyRolePower(){
	...
	var url='${pageContext.request.contextPath }/SysRoleList/copyRolePower.action?roleId='+'${param.roleId}'+'&selectRoleIds='+selectId+'&type='+'${param.type}';
	$.ajax({
		url:url,
		type:'post',
