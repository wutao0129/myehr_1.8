...
<div class="container-fluid">
	<div style="margin-top:5px;">
		<input id="SYS_MENU.menuId" name="menuId" type="hidden" class="form-control"  style="width:200px;"/>
		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center">员工信息</h3>
			...
			<tr style="height:65px">
				...
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_MENU.menuCode" name="menuCode" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;"  readonly="true" style="width:200px;"/></td>
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单名称")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_MENU.menuName" name="menuName" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;"  readonly="true" style="width:200px;"/></td>
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单类型")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  >						<select id="SYS_MENU.menuType" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单类型")%>" name="menuType"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_MENU_TYPE" nullItemText="请选择..." dataField="dicts"></select></td>
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单业务类型")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  >						<select id="SYS_MENU.menuDicCode" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单业务类型")%>" name="menuDicCode"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_MENU_BUSINESS_TYPE" nullItemText="请选择..." dataField="dicts"></select></td>
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"上级菜单编码")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_MENU.menuParentCode" name="menuParentCode" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;"  readonly="true" style="width:200px;"/></td>
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"排序")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_MENU.menuSort" name="menuSort" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;"/></td>
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"操作者")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_MENU.operatorName" name="operatorName" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;"  readonly="true" style="width:200px;"/></td>
				...
				<td style="padding-left:10px;"  align="left"  >
					<div class='controls input-append date form_date1' data-date=""  data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" style="float:left;">
						<input type='text' readonly class="form-control " dateType="controls input-append date form_date1" id="SYS_MENU.operatorTime"  style="width:200px;" name="operatorTime"  format="yyyy-MM-dd" valueformat="yyyy-MM-dd" />
...
$(function () {  
	...
	window.onload=function(){
		...
		document.getElementById("SYS_MENU.menuId").value="${param.menuId}";
	...
	function _initData(pkId){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/SysMenuList/findSysMenuById.action?menuId='+menuId,
			type:'post',
			//data: JSON.stringify(_param),
			cache: false,
			contentType: 'application/json;charset=utf-8',
