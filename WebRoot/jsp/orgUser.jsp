...
<div title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单树")%>" region="west" style="float:left;overflow:auto;width:100%;height:100%" bodyStyle="overflow:hidden;" showHeader="false"
	showFilter="false"
...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/SysRoleList/buildFlowTree.action",//ajax的请求地址
...
var ORG_ABBREVIATION = node.ORG_ABBREVIATION ? node.ORG_ABBREVIATION.toLowerCase() : "";
	...
	function checkMenus(){
		...
		$.ajax({
            url: '/myehr/SysRoleList/saveActWithUser.action',
		    type:'post',
