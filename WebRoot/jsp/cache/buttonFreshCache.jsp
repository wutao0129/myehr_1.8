	...
	<div style="margin-top:5px;">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"选择")%> onclick="choose()"/>
			</div>
		</div>
		<div id="grid_org_list_filter" style="float:right;display:inline-block;margin-right:155px;position:relative;">
			<input id="FILTER_1041" name="FILTER_1041" placeholder="字典类编码,字典类名称" style="padding: 6px 30px 6px 10px;" title="字典类编码,字典类名称" type="text" class="form-control" oninput="grid_org_list_fun11()" />
...
function choose(){
	...
	$.ajax({
		url:'${pageContext.request.contextPath }/cache/saveCacheConfigs.action?buttonId=${param.buttonId}',
		type:'post',
		cache: false,
		contentType: 'application/json;charset=utf-8',
...
function grid_org_list_fun(pageReqeust){
	...
	_filterdata={searchValue:searchValue,deleteMark:deleteMark,dictClass:'SQL'};
	var userId = '${sessionScope.userid}';
	var paramsMap = {userId:userId};
	var requestParam={};
	var nodeId = 'dictTypeClassSQL';
