...
<div title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"菜单树")%>" region="west" style="float:left;overflow:auto;width:200px;height:100%" bodyStyle="overflow:hidden;" showHeader="false" showFilter="false" class="sub-sidebar" allowResize="false">
	...
	<div id="iframe" title="center" region="center" style="border:0;width:80%;height:100%;float:left;">
...
var setting = {
			...
			async: {
				enable:true, // 需要异步加载
				type:"get",
				url:"${pageContext.request.contextPath }/form/buildFlowTree.action?type=daipi",//ajax的请求地址
		...
		var paramtabs_map = {N: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"流程管理树")%>', url:'<%= basePath%>jsp/act/actManage/toDoList.jsp'}]};
