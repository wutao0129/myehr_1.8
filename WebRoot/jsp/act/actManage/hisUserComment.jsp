    ...
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="addorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"转办")%> onclick="selectUsers()"/>
			</div>
		</div>
...
$(function() {
    ...
    function querys() {
        $("#scheme_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/act/task/queryHisUserComment.action?procInsId='+'${param.procInsId}'+'&taskId='+'${param.taskId}',
...
function selectUsers(){
	...
	var url='/myehr/act/task/turnTo.action?procInsId='+procInsId+'&taskDefKey='+taskDefKey+'&userId='+select.userId;
