...
$(document).ready(function () {
	$.ajax({  
        type: 'POST',  
        url: '${pageContext.request.contextPath }/EntityList/selectTree.action',  
...
//节点点击事件
	function onClickNode(e, treeId, treeNode) {
    	...
    	if(treeNode.isParent==true){
    		...
    		document.getElementById("dictList").src="SysEntity.jsp?entityType="+treeNode.pId;
    		}else{
    		document.getElementById("dictList").src="SysEntity.jsp?entityType="+treeNode.id;
    		}
    	}else{
    		document.getElementById("dictList").src="../field/SysField.jsp?entityId="+treeNode.id;
    	}
    	return false;
	}
