...
<tr class="topRow">
	<td class="top" colspan="3">
		<div style="width:70%;float: left;height:100%;padding-top:15px;"><img id = "gongsiname" /></div>
	</td>
</tr>
<tr class="centerRow">
	<td class="emptyTd">&nbsp;</td>
	<td align="center">
		<div align="center" >
				<div class="imgcontainer">
				    ...
				    <div class="login" style="border-radius: 5px;behavior:url(${pageContext.request.contextPath }/common/nui/PIE.htc);height:350px;">
				      <form id="form1" class="nui-form" method="post" action="${pageContext.request.contextPath }/user/login.action">
				        ...
				        <p>
						 ...
						 <div class="checkeddata" style="padding-left: 40px;">
						   <input id="t1" type="text" name="u"  placeholder="验证码" onblur="but()" style="display: none;width: 168px;height: 40;padding-left: 10px;" />
						   <span id="discode"></span>
						   <input type="button" value="换一换" id="checkeddata" class="c" style="height: 40px;display:none"onClick="createCode()" >
						  </div>
...
{//验证验证码输入是否正确
 ...
 function init(){
	...
	$.ajax({
					...
					path1 ="${pageContext.request.contextPath }/images/login/"+rules[1]
