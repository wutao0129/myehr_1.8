    ...
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="addorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"切换")%> onclick="selectUsers()"/>
			</div>
		</div>
...
function selectUsers(){
	...
	var url='/myehr/user/login.action?loginType=change&userCode='+select.userCode;
