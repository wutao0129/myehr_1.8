...
<div class="container-fluid">
	<div style="margin-top: -25px;">
		<table style="margin-top:20px;width: 500px;margin: 75px auto 20px  auto;" class="cbs-table"  >
		<h1 style="width: 379px;margin: 35 auto;">请修改密码</h1>
			<tr style="height:65px;margin-top: 80px;">
				<td style="padding-left:10px;font-size: 15;"  width="150"  ><lable>用户名: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="userName" name="userName" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;"  readonly="true" style="width: 300px;height: 40px;font-size: 15px;"/></td>
			</tr>
			<tr style="height:65px;margin-top: 80px;">
				<td style="padding-left:10px;font-size: 15;"  width="150"  ><lable>输入旧密码: </lable></td>
				<td style="padding-left:10px;"  align="left"  >
				
				<input id="oldPassword" name="oldPassword" type="text" class="form-control"  style="width: 300px;height: 40px;font-size: 15px;"  onfocus="this.type='password'" autocomplete="off" />
			...
			<tr style="height:65px;margin-top: 80px;">
				<td style="padding-left:10px;font-size: 15;"  width="150"  ><lable>输入新密码: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="newPassword" name="newPassword" type="password" class="form-control"  style="width: 300px;height: 40px;font-size: 15px;" readonly="true" onblur="checknewpd()"/>
				<span id="difpwd" name="difpwd" style="color:red;"></span>
				</td>
			</tr>
			<tr style="height:65px;margin-top: 80px;">
				<td style="padding-left:10px;font-size: 15;"  width="150"  ><lable>重新输入新密码: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="password" name="password" type="password" class="form-control"  style="width: 300px;height: 40px;font-size: 15px;" readonly="true"/></td>
				
			</tr>
		</table>
	</div>
	<div style="margin:0 auto">
		<div style="margin-right:10px;display:inline-block;width: 436px;margin:  0 auto;">
