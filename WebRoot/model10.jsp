...
function loadJs(){	
    ...
    toolbox: {
        ...
        feature : {
            mark : {show: true},
            dataView : {show: toolbox_feature_dataView_show, readOnly: false},
            restore : {show: true},
            saveAsImage : {show: toolbox_feature_saveAsImage}
        }
    },
    calculable : true,
    polar : [
        {
			 nameGap : polar_nameGap, // 图中工艺等字距离图的距离
			 radius: polar_radius,
                        splitNumber: polar_splitNumber, // 网格线的个数
                        center:[polar_center_x,polar_center_y], // 图的位置
                        name:{
                           show: polar_name_show, // 是否显示工艺等文字
                           
                           textStyle: {
                             color:polar_name_color // 工艺等文字颜色
                           }
                         },
            indicator : [
                {text : '进攻', max  : 100},
