...
function showChartsInfoStep2(data){
	$("#chartsBarColumnId").val(data.chartsBarColumnId);
	$("#barChartsColumnType").val(data.chartsBarColumnType);
	$("#barChartsColumnColor").val(data.chartsBarColumnColor);
	$("#barChartsPieType").val(data.chartsPieType);
	$("#pieOuterRingDiameter").val(data.pieOuterRingDiameter);
	$("#pieInnerRingDiameter").val(data.pieInnerRingDiameter);
}

function showTextInfoStep2(data){
	$("#textboxId").val(data.textboxId);
	$("#barChartsColumnType").val(data.barChartsColumnType);
		...
		layer.open({
			...
			yes: function(index, layero){
				for(var i = 0 ;i<sforms.length;i++){
					sforms[i].formColumnAlign = $("#align_step2").val();
					sforms[i].formColumnWidth = $("#width_step2").val();
					sforms[i].formColumnRequired = $("#required_step2").val();
					sforms[i].formColumnGroupId = $("#group_step2").val();
					sforms[i].formColumnShowType = $("#showType_step2").val();
				}
