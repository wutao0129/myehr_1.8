    ...
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="addorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"选择")%> onclick="selectRoles()"/>
			</div>
		</div>
...
$(function() {
    ...
    function querys() {
        $("#scheme_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/SysMenuList/queryRoleList.action',
                ...
                formatter: function (value, row, index) {
                    if(value==undefined){
                        value='-';
                    	  ...
                    	  return "<a  class=\"eli w50\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"roleStatus\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"用户状态\">"+value+"</a>";
                }
            },
            {
...
function selectRoles(){
	...
	$.ajax({
		url: '/myehr/SysMenuList/saveRolesWithScheme.action',
		type:'post',
