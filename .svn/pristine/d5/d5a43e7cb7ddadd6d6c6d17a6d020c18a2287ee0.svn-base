...
<div class="container-fluid">
	...
	<div class="row" style="padding:0 12px">
		...
		<div class="col-md-3 col-sm-3 col-lg-3">
			<div class="box-content" id="4003">
				<table id="WARNING_BRITHDAY_CARD">
				</table>
				<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
				<div class="row" style="margin-left:0" id="WARNING_BRITHDAY">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 col-lg-3">
			<div class="box-content" id="4032">
				<table id="WARNING_BORROW_CARD">
				</table>
				<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
				<div class="row" style="margin-left:0" id="WARNING_BORROW">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 col-lg-3">
			<div class="box-content" id="4181">
				<table id="WARNING_EMP_CADRE">
				</table>
				<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
				<div class="row" style="margin-left:0" id="WARNING_EMP">
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 col-sm-3 col-lg-3">
			<div class="box-content" id="4797">
				<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
				<div class="row" style="margin-left:0" id="ZM_ATT_ATTEND_OVERTIME_HIS">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 col-lg-3">
			<div class="box-content" id="4797">
				<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
				<div class="row" style="margin-left:0" id="WARNING_CONCOUNT">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 col-lg-3">
			<div class="box-content" id="4797">
				<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
				<div class="row" style="margin-left:0" id="WARNING_PRO_CARD">
				</div>
			</div>
		</div>
...
$(function() {
	...
	showDate_KNOB();//流程信息
	loadDataStart_4795();//分支行人数
	loadDataStart_4796();//本年度新入职人数
	loadDataStart_4797();//总行部门人数
	loadDataStart_4799();//本年度离职人数
	loadDataStart_5011();//请假天数
	loadDataStart_5010();//年假天数
	loadDataStart_5017();//加班时间
	loadDataStart_3999();//合同到期
	loadDataStart_4017();//试用期到期提醒
	loadDataStart_4003();//下月生日提醒
	loadDataStart_4032();//外单位借调
	loadDataStart_4181();//干部试用期到期
	loaddata();//制度
	cardSelectInitFunctionx("");
	cardDateWidInitFunction();
	getEmpPhotoSYS();//人员照片加载
});
