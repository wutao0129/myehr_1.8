...
<div class="input-group">
	...
	<div id="grid_org_list_filter" style="float:right;display:none;margin-right:155px;position:relative;">
		<input id="FILTER_3270" name="FILTER_3270" placeholder="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"参数名称")%>" style="padding: 6px 30px 6px 10px;" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"参数名称")%>" type="text" class="form-control" oninput="grid_org_list_fun11()" />
...
$(function() {
    ...
    function querys_3270() {
        $("#org_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/act/model/searchFormParamList.action',
