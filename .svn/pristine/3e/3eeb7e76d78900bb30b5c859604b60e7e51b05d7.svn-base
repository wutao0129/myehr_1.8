...
public class SysFormGridCache implements Serializable {
	/**
	 * 
	 */
...
//	保留关联表单引用对象
	 ...
	 *
	 */
	public SysFormGridCache(){};
	
	/**
	 * 构造函数 数据库加载
	 * @param formGridFormId
	 */
	public SysFormGridCache(String formGridFormId,String formCode){
		...
		if(obj==null){
//			log.error("无法获取表单编码为:"+formCode+"对应的grid信息");
			System.out.println("无法获取表单编码为:"+formCode+"对应的grid信息");
			return ;
		}
