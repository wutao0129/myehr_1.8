                                        ...
                                        <h3 style="display:block;font-size:18;text-align:left;height: 36px;line-height: 33px;padding-left: 16px;color: #666;cursor: pointer;">基础信息</h3>
                                            <div class="row cell" id="form1" >
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
														<lable style="float:left">选择试卷模板</lable>
														<input id="expand1" name="expand1" type="hidden" />
														<input id="expandField" name="expandField" type="text" placeholder="选择试卷模板" class="form-control" readonly style="width:200px;float:left" />
														<input type="button" id="choosePaper"  class="btn btn-primary" style="float:left" value='选择试卷模板 ' onclick="choosePaper()"/>
													</div>
												</div>
...
function choosePaper(){
	var url = '/myehr/jsp/form/formcreate/QUESTION/chooseQuestionForm.jsp';
	layer.open({
		type:2,
		closeBtn:1,
		shadeClose:true,
