...
<div class="container-fluid">
	<div style="margin-top:5px;">
		<input id="SYS_SYSTEM_SCHEME.solutionId" name="solutionId" type="hidden" class="form-control"  style="width:200px;"/>
		<input id="SYS_SYSTEM_SCHEME.folderId" name="folderId" type="hidden" class="form-control"  style="width:200px;" value="<%=nodeId %>"/>
		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center"></h3>
			...
			<tr style="height:65px">
				...
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_SYSTEM_SCHEME.solutionCode" name="solutionCode" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;"/></td>
				
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"方案名称")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_SYSTEM_SCHEME.solutionName" name="solutionName" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;"/></td>
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"方案分类")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><select id="SYS_SYSTEM_SCHEME.solutionParentId" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"新增方式")%>" name="solutionParentId"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" data="[{id:'1',text:'业务类'},{id:'2',text:'技术类'}]" DictName="" nullItemText="" dataField="dicts"></select></td>
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"排序")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_SYSTEM_SCHEME.solutionSort" name="solutionSort" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;"/></td>
			</tr>
		</table>
	</div>
...
$(function () {  
	...
	window.onload=function(){
		...
		document.getElementById("SYS_SYSTEM_SCHEME.solutionId").value="${param.solutionId}";
		var solutionId = '${param.solutionId}';
		
		if(solutionId!='' && solutionId!=null){
			_initData(solutionId);
		}
	...
	function save_formemp_emp_edit_click_1881(){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/scheme/saveScheme.action',
			type:'post',
	...
	function _initData(pkId){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/scheme/querySchemeById.action?solutionId='+solutionId,
			type:'post',
			//data: JSON.stringify(_param),
			cache: false,
			contentType: 'application/json;charset=utf-8',
