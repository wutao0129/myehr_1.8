...
<div class="input-group">
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			...
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="edit1org_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"删除")%> onclick="deleteRoleUser()"/>
			</div>
		</div>
...
function deleteRoleUser(){
	...
	var url='${pageContext.request.contextPath }/SysRoleList/deleteRoleUser.action?roleId='+'${param.roleId}'+'&userId='+selectId;
	$.ajax({
		url:url,
		type:'post',
