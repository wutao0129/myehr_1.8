...
<body>
<!-- <div><input id="test" value=""><input id="test1" value=""></div> -->
...
<div style="background-color: #fafafa;"><!-- 右键菜单div -->  
	<div id="rMenu" style="position:absolute; display:none;">
		<p><button id="add" class="btn btn-primary btn-xs" onclick="add();"><i class="glyphicon glyphicon-plus"></i> 增加</button></p>
		<p><button id="remove" class="btn btn-danger btn-xs" onclick="remove();"><i class="glyphicon glyphicon-remove"></i> 删除</button></p>
		<p><button id="update" class="btn btn-info btn-xs"  onclick="update();"><i class="glyphicon glyphicon-pencil"></i> 修改</button></p>
	</div>
</div>
<script>
