...
public class SysFormTreeSolutionCacheCopy implements Serializable {
	...
	private static final long serialVersionUID = 1L;
		...
		private List<SysFormTreeSolutionColumnCacheCopy> columns = new ArrayList<SysFormTreeSolutionColumnCacheCopy>();
...
//		 参数集合
		...
		public List<SysFormTreeSolutionColumnCacheCopy> getColumns() {
			return columns;
		}

		public void setColumns(List<SysFormTreeSolutionColumnCacheCopy> columns) {
		 ...
		 *
		 */
		public SysFormTreeSolutionCacheCopy(){};
		
		/**
		 * 构造函数 
		 * @throws Exception 
		 */
		public SysFormTreeSolutionCacheCopy(String treeSolutionId) throws Exception{
//			ISysFormTreeService service = (ISysFormTreeService)ApplicationContextFactory.getContext().getBean("ISysFormTreeService");
			...
			if(objs!=null){
				for(SysTreeSolutionColumn temp:objs){
					SysFormTreeSolutionColumnCacheCopy c = new SysFormTreeSolutionColumnCacheCopy(temp); 
					columns.add(c);
				}
			}
		}
		 ...
		 * @param obj
		 */
		public void setThisByDataObject(SysTreeSolution obj) {
			System.out.println(obj.getTreeSolutionName());
