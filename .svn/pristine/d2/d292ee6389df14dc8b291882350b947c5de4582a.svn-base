                                    ...
                                    <div style="margin-top:5px;">
                                        ...
                                        <h3 style="display:block;font-size:18;text-align:left;height: 36px;line-height: 33px;padding-left: 16px;color: #666;cursor: pointer;">基础信息</h3>
                                            <div class="row cell" id="form1" >
											    ...
											    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        <lable style="float:left">是否可评论</lable>                      
                                                        <select id="isEvaluate" title="是否可评论" styleType="select" name="isEvaluate"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
                                                    </div>
                                                </div>
												   <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        <lable style="float:left">是否可回复</lable>                      
                                                        <select id="isReplay" title="是否可回复" styleType="select" name="isReplay"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_COMMON_YES_NO" dataField="dicts"></select>
                                                    </div>
                                                </div>
...
function formInit(){
	...
	$.ajax({
		...
		success: function (data) {
			...
			if(data.isEvaluate!=null&&data.isEvaluate!=""){
				$("#isEvaluate").val(data.isEvaluate);
			}else{
				$("#isEvaluate").val("N")
			}
			if(data.isReplay!=null&&data.isReplay!=""){
				$("#isReplay").val(data.isReplay);
			}else{
				$("#isReplay").val("N")
			}
...
function saveFormInfo(){
	...
	Param.isEvaluate= $("#isEvaluate").val();
	param.isReplay= $("#isReplay").val();
