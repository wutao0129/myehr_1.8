...
public class SysFormTextarea {
    private BigDecimal textareaId;

    private BigDecimal textareaFormColumnId;
    ...
    public BigDecimal getTextareaFormColumnId() {
        return textareaFormColumnId;
    }

    public void setTextareaFormColumnId(BigDecimal textareaFormColumnId) {
        this.textareaFormColumnId = textareaFormColumnId;
    }
