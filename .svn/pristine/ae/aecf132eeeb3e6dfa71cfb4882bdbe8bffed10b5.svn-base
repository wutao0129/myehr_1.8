 ...
 */
ORYX.CONFIG.APP_PATH=                   appContextRoot+"/process-editor";
...
ORYX.CONFIG.PLUGINS_CONFIG =				ORYX.CONFIG.APP_PATH+"/editor-app/plugins.xml";
...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    ...
    construct: function(source, modelMetaData, editorId){
		...
		if(ORYX.CONFIG.BACKEND_SWITCH) {
			...
			new Ajax.Request(ACTIVITI.CONFIG.contextRoot + '/editor/stencilset.action?version=' + Date.now(), {
	            asynchronous: false,
	            method: 'get',
