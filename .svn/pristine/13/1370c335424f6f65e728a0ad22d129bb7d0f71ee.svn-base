...
var setting = {
		...
		var paramtabs_map = {N: [{title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"表单目录树")%>', url:'<%= basePath%>jsp/form/formcreate/formList.jsp'}]}		
		...
		function onClick(event, treeId, treeNode){  
				...
				var url = '<%= basePath%>jsp/form/formcreate/formList.jsp';
	...
	**/
	...
	function OnRightClick(event, treeId, treeNode) {
		...
		content =   "<div id='treeNode' class='row cell' style='border:none;line-height:25px;height:95%;overflow:auto;' >\n"+
					"<p>当前选中的节点是:"+treeNode.FOLDER_TREE_NAME+"</p>\n"+
