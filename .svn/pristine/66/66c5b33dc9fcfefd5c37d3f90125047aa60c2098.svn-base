...
public class SysDictEntryExpand extends SysDictEntry{
    ...
    public String getDictTypeRemark() {
        return dictTypeRemark;
    }

    public void setDictTypeRemark(String dictTypeRemark) {
        this.dictTypeRemark = dictTypeRemark == null ? null : dictTypeRemark.trim();
    }

    public String getDictTypeClass() {
        return dictTypeClass;
    }

    public void setDictTypeClass(String dictTypeClass) {
        this.dictTypeClass = dictTypeClass == null ? null : dictTypeClass.trim();
    }
