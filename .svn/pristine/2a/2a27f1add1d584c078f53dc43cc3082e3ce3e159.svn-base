		...
		<div style="border:1px solid #ccc; position:relative;border-radius:5px;margin-bottom:10px">
			...
			<tr style="height:65px" width="100%">
				...
				<td style="padding-left:10px;"  align="left" width="10%"  >
					<input id="SYS_SYSTEM_SCHEME.ruleFormName" name="ruleFormName" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:100%;position:absolute"/><i style="position:relative;left:180px;top:5px" onclick="choseForm()" class="glyphicon glyphicon-plus"></i>
					<input id="SYS_SYSTEM_SCHEME.ruleFormId" name="ruleFormId" type="hidden" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:100%;position:absolute"/>
				</td>
			</tr>
		</table>
	</div>
