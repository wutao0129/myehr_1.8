...
<div class="container-fluid">
	<div style="margin-top:5px;">
		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center"></h3>
			...
			<tr style="height:65px">
				<lable style="float:left">国籍: </lable><label for="DEPTCODE.DEPTCODE_DEPTCODE01_469"></label>
				<select id="DEPTCODE.DEPTCODE_DEPTCODE01_469" title="国籍" name="DEPTCODE_DEPTCODE01"  class="selectpicker bla bla bli" multiple data-live-search="true" emptyText="请选择..."  style="width:200px;" textField="dictName" valueField="dictID" DictName="nation" dataField="dicts_form_11241" multiSelect="true" initParam = "_"></select>
			</tr>
			<tr style="height:65px">
