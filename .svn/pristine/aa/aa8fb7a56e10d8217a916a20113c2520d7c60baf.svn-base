	...
	<div style="margin-top:5px;">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"选择")%> onclick="editScheme()"/>
			</div>
		</div>
        ...
        $("#scheme_list_List").bootstrapTable({
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"dictTypeId\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"方案Id\">"+value+"</a>";
                }
            },
            {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;color:black;width:150px;\" name=\"dictTypeName\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"字典类名称\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:60px;\" name=\"dictTypeClass\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"字典类分类\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=SYS_DICT_CLASS\"></a>";
                }
            },
			{
...
function grid_org_list_fun(pageReqeust){
	...
	_filterdata={searchValue:searchValue,dictClass:'${param.dictClass}'};
