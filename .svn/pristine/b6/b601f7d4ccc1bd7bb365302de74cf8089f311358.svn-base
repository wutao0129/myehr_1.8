    ...
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"授权")%> onclick="editMenu()"/>
			</div>
		</div>
...
$(function() {
    ...
    function querys_1041() {
        $("#org_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/SysRoleList/querySelectUserList.action',
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
					...
					return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"userName\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"用户名称\">"+value+"</a>";
                }
            },
            ],
...
function editMenu(){
	...
	$.ajax({
		url: '/myehr/SysRoleList/saveRoleUser.action',
		type:'post',
