    ...
    <div id="grid_org_list_filter">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="addorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"引入用户")%> onclick="introduceUsers()"/>
			</div>
		</div>
...
$(function() {
    ...
    function querys() {
        $("#scheme_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/SysMenuList/querySchemeUserList.action',
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:60px;\" name=\"userPassword\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"用户密码\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=SYS_MENU_TYPE\"></a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:60px;\" name=\"userTalephone\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"用户电话\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=SYS_MENU_BUSINESS_TYPE\"></a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    if(value==undefined){
                        value='-';
                    	  ...
                    	  return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"userEmail\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"用户邮箱\">"+value+"</a>";
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                    if(value==undefined){
                        value='-';
                    	  ...
                    	  return "<a  class=\"eli w50\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"userStatus\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"用户状态\">"+value+"</a>";
                }
            },
            {
...
function introduceUsers(){
	...
	if(schemeId=='' || schemeId==null || schemeId==undefined){
		alert("请选择方案");
		return;
	}
	var url='/myehr/system/menu/userList.jsp?schemeId='+schemeId;
	
	parent.layer.open({
		type: 2,
		title:'<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"引入用户")%>',
		shadeClose: true,
		shade: 0.8,
		maxmin:true,
		zIndex:9999,
