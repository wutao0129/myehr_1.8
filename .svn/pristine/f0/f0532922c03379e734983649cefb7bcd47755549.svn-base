...
$(function() {
    ...
    function querys_1041() {
        $("#org_list_List").bootstrapTable({
            url :'${pageContext.request.contextPath }/form/queryFlowList.action',
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"processDefId\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"部署ID\">"+value+"</a>";
                }
            },
			{
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"流程类型")%>',
                field : 'flowType',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"flowType\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"流程类型\">"+value+"</a>";
                }
            },
			{
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"processinstid\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"流程实例ID\">"+value+"</a>";
                }
            },
			{
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"业务主键ID")%>',
                field : 'businessinstid',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"businessinstid\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"业务主键ID\">"+value+"</a>";
                }
            },
			{
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"任务ID")%>',
                field : 'taskId',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"taskId\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"任务ID\">"+value+"</a>";
                }
            },
			{
			...
			{
                title : '<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"任务处理人")%>',
                field : 'taskUserId',
                align : 'center',
                visible : true,
                valign : 'left',
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w100\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"taskUserId\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"任务处理人\">"+value+"</a>";
                }
            },
			{
