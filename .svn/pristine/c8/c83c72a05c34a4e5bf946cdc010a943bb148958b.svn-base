...
<form id="form_3270" name="form_3270" >
<div class="container-fluid" style="overflow-y:auto;">
	<div class='my_card' style="margin-top:5px;padding-bottom:50px;">
<input id="ATT_LEAVE.AL_ID_3270" name="AL_ID" type="hidden" class="form-control"  style="width:200px;"/>
		<div class='row cell'>
...
<input id="ATT_LEAVE.AL_TYPE_3270" name="AL_TYPE" type="text" class="form-control"  vtype="illegalChar;maxLength:3;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"审批状态")%>: </lable>
<input id="ATT_LEAVE.APPROVE_STATUS_3270" name="APPROVE_STATUS" type="text" class="form-control"  vtype="illegalChar;maxLength:6;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"审批时间")%>: </lable>
<input id="ATT_LEAVE.APPROVE_TIME_3270" name="APPROVE_TIME" type="text" class="form-control"  vtype="illegalChar;maxLength:11;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"主题")%>: </lable>
<input id="ATT_LEAVE.AL_TITLE_3270" name="AL_TITLE" type="text" class="form-control"  vtype="illegalChar;maxLength:166;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"审批标示")%>: </lable>
<input id="ATT_LEAVE.AL_OUT_TIME_3270" name="AL_OUT_TIME" type="text" class="form-control"  vtype="illegalChar;maxLength:3;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"提交审批日期")%>: </lable>
<input id="ATT_LEAVE.AL_POST_DATE_3270" name="AL_POST_DATE" type="text" class="form-control"  vtype="illegalChar;maxLength:7;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请假开始日期")%>: </lable>
<input id="ATT_LEAVE.AL_STARTDATE_3270" name="AL_STARTDATE" type="text" class="form-control"  vtype="illegalChar;maxLength:7;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"操作类型")%>: </lable>
<input id="ATT_LEAVE.AL_OPERTYPE_3270" name="AL_OPERTYPE" type="text" class="form-control"  vtype="illegalChar;maxLength:3;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请假结束日期")%>: </lable>
<input id="ATT_LEAVE.AL_ENDDATE_3270" name="AL_ENDDATE" type="text" class="form-control"  vtype="illegalChar;maxLength:7;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请假天数")%>: </lable>
<input id="ATT_LEAVE.AL_DAYS_3270" name="AL_DAYS" type="text" class="form-control"  vtype="illegalChar;maxLength:10;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"销假原因")%>: </lable>
<input id="ATT_LEAVE.AL_XJREASON_3270" name="AL_XJREASON" type="text" class="form-control"  vtype="illegalChar;maxLength:666;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"销假附件")%>: </lable>
<input id="ATT_LEAVE.AL_XJFILES_3270" name="AL_XJFILES" type="text" class="form-control"  vtype="illegalChar;maxLength:10;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请假开始时间")%>: </lable>
<input id="ATT_LEAVE.AL_STARTTIME_3270" name="AL_STARTTIME" type="text" class="form-control"  vtype="illegalChar;maxLength:3;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"销假时记录请假ID")%>: </lable>
<input id="ATT_LEAVE.AL_QJID_3270" name="AL_QJID" type="text" class="form-control"  vtype="illegalChar;maxLength:20;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请假结束时间")%>: </lable>
<input id="ATT_LEAVE.AL_ENDTIME_3270" name="AL_ENDTIME" type="text" class="form-control"  vtype="illegalChar;maxLength:3;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"请假原因")%>: </lable>
<input id="ATT_LEAVE.AL_REASON_3270" name="AL_REASON" type="text" class="form-control"  vtype="illegalChar;maxLength:166;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"附件上传")%>: </lable>
<input id="ATT_LEAVE.AL_ADJUNCT_3270" name="AL_ADJUNCT" type="text" class="form-control"  vtype="illegalChar;maxLength:10;minLength:null;"  style="width:200px;"/>
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"人员表主键ID")%>: </lable>
<input id="ATT_LEAVE.AL_EMP_ID_3270" name="AL_EMP_ID" type="text" class="form-control"  vtype="illegalChar;maxLength:20;minLength:null;"  style="width:200px;"/>
</div>
</div>
		</div>
		<div class="BTNGROUP BTNGROUP_3270" style="margin:0 auto; display:inline-block;height: 30px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="save_formAttLeaveTest"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"保存(卡片式)")%> onclick="save_formAttLeaveTest_click_3270()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
...
function getdata_3270(buttonId,formId){
			var param = {};
	...
	function save_formAttLeaveTest_click_3270(){
		var paramsMap = {};
		var _param = {};
		_param.formId=_formId_3270;
		_param.buttonId=4615;
		_param = getdata_3270(_param.buttonId,_formId_3270);
...
function submit2(flowInstanceId,type,user,remark,taskId,approveType){
	if(type){
		...
		_param = getdata_3270(_param.buttonId,_formId_3270);
		_param.paramsMap = paramsMap;
		_param.actFlowParams= {key:'${param.key}',user:user,type:type,remark:remark,taskId:taskId,approveType:approveType};
		var url = "/myehr/jsp/freeFlow/confirmFlowSubmit.jsp?processinstid=${param.processinstid}&taskId=${param.taskId}";
	...
	function _initData(pkId){
		var _param = {};
		if(pkId){
			_param = {pkId:pkId,formId:_formId_3270};
		}else {
			_param = {requestParam:{},pkId:pkId,formId:_formId_3270};
		}
		var _form = getForm("#form_3270");
		var _Type = getType("#form_3270");
		$.ajax({
