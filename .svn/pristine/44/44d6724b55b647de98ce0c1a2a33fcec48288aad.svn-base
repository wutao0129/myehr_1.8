...
function setUrlParam(url,params){
	...
	function transmit(formID,formName){
		...
		var formId1='${param.formId}';
		var formName1='${param.formName}';

		window.parent.document.getElementById(formId1).value=formID;
		window.parent.document.getElementById(formName1).value=formName;
