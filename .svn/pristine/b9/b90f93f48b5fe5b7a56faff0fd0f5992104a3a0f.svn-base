	...
	<div style="margin-top:5px;">
		...
		<div class="BTNGROUP_1041" style="margin:0 auto; display:inline-block;height: 35px;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"选择")%> onclick="selectScheme()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editorg_list"  class="btn btn-primary" value=<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"取消")%> onclick="closex()"/>
			</div>
		</div>
		<div style="margin-right:10px;display:inline-block">
        ...
        $("#scheme_list_List").bootstrapTable({
            ...
            },
			{
                ...
                formatter: function (value, row, index) {
                    ...
                    return "<a  class=\"eli w50\" style=\"font-size:14px;text-decoration:none;color:black;width:200px;\" name=\"deleteMark\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"删除标志\">"+value+"</a>";
                }
            },
            ],
...
function selectScheme(){
	...
	var id = selects[0].treeSolutionId;
	var name = selects[0].treeSolutionName;
