...
function setUrlParam(url,params){
	...
	function transmit(formID,formName){
		...
		if(cardType=='treeEdit'){
			window.parent.document.getElementById("SYS_SYSTEM_SCHEME.ruleFormId").value=formID;
			window.parent.document.getElementById("SYS_SYSTEM_SCHEME.ruleFormName").value=formName;
			window.parent.buildFormField(formID);
		}else{
			window.parent.document.getElementById("SYS_SYSTEM_SCHEME.ruleFormId").value=formID;
			window.parent.document.getElementById("SYS_SYSTEM_SCHEME.ruleFormName").value=formName;
			window.parent.buildFormField(formID);
