...
var setting = {
		...
		function onAsyncSuccess(event, treeId, treeNode){
				...
				document.getElementById("main").src = "/myehr/jsp/form/formcreate/dragconfig/formDragconfig.jsp";
		}
		...
		function onClick(event, treeId, treeNode){  
	    		if(treeNode.id=='root'){
	    			document.getElementById("main").src="/myehr/jsp/form/formcreate/dragconfig/formDragconfig.jsp?formDragconfigPid=0";
	    		}else{
					document.getElementById("main").src="/myehr/jsp/form/formcreate/dragconfig/formDragconfig.jsp?formDragconfigPid="+treeNode.id;
				}
	    	return false;
		}; 
