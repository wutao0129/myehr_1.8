 ...
 * @version 2013-12-05
 */
public class ProcessDefCache implements Serializable {
	...
	public static ProcessDefinition get(String procDefId) {
		ProcessDefinition pd = null;//(ProcessDefinition)CacheUtils.get(ACT_CACHE, ACT_CACHE_PD_ID_ + procDefId);
		if (pd == null) {
			RepositoryService repositoryService = (RepositoryService) SpringContextUtils.getBeanById("repositoryService");
