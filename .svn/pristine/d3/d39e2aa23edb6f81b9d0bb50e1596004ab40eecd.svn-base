...
<div class="container-fluid">
	<div class="row" style="margin-left:0;position:relative;overflow-x:hidden" id="TEST_INFO_FORM">
		<div class="col-md-6 col-sm-6 col-lg-6">
			...
			<div class="col-md-6 col-sm-6 col-lg-6">
				<div class="box-content" id="4498">
					<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
					<div class="row" style="margin-left:0" id="ZM_ATTEND_EMPLEAVEBLANCE">
					</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-lg-6">
				<div class="box-content" id="4499">
					<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
					<div class="row" style="margin-left:0" id="ZM_ATT_LEAVE_HIS">
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-6 col-lg-6 kuangClass" style="padding-left:0px">
			<div class="row" style="margin-left:0;height:175px;background-color:#FFF;margin-right: 10px;border-radius:10px;position:relative"  id="">
				<h4 style="font-weight:700;text-align:center;">新闻公告</h4><input class="form-control" type="text" style="width:200px;position:absolute;top:10px;right:20px;" placeholder="标题" id="ANNOUNCEMENT_TITLE" onchange="loaddata()"/>
	...
	<div style="position:relative;height:300px">
		<div style="width:100%;height:300px;overflow-y:hidden;margin-bottom:10px">
			<div class="row-fluid TUpage TUpage1" style="padding:0 27px;height:450px;margin-bottom:20px">
				<div class="span12">
					<div class="box-content" id="4431">
						<div id="activity_pane" style="position:absolute;left:500px;top:70px"></div>
						<div id="ZM_payemp_TU_chart" style="width:100%;height:450px;"></div>
					</div>
				</div>
			</div>
...
<script>
	var _formId_4499='4499';
	var _formId_4599='4599';
var USERID;
var heightGadedata_4499 =[];
var containerParam_4499 ={};
containerParam_4499 ={};
function changeHeightGadedata_4499(data){
	heightGadedata_4499 = data;
}
...
function changeHeightGadedata_4413(data){
	...
	var _formId_4498='4498';
var USERID;
var heightGadedata_4498 =[];
var containerParam_4498 ={};
containerParam_4498 ={};
function changeHeightGadedata_4498(data){
	heightGadedata_4498 = data;
}
...
var heightGadedata_4599 =[];
var containerParam_4599 ={};
containerParam_4599 ={};
function changeHeightGadedata_4599(data){
	heightGadedata_4599 = data;
}
	...
	for (var i = arr.length - 1; i >= 0; i--) {
		...
		if(arr[i].EMPVEMPBASIC_MOBILE==null){
			...
			var cellObj = $(
				...
				'                <div class="row" id="row" style="width:450px">'+
...
function searchEmpInfo(){
	...
	var url = '/myehr/jsp/workDesk/emp_emp_list_zm.jsp?formId=4468&ORIGIN='+ORIGINval+'&EMPCODE='+EMPCODEval+'&CNAME='+CNAMEval+'&COMPID='+COMPIDval+'&DEPID='+DEPIDval+'&GENDER='+GENDERval+'&MAXEDUCATION='+MAXEDUCATIONval+'&TITLELEVEL='+TITLELEVELval+'&EMPTYPE='+EMPTYPEval;
	var title = '人员检索';
	layer.open({
		type: 2,
		title: title,
...
function grid_ZM_ATTEND_EMPLEAVEBLANCE_fun(pageReqeust){
	var _filterdata={};
	if(document.getElementById('grid_ZM_ATTEND_EMPLEAVEBLANCE_filter')){
	}
	var paramsMap = {};
	var requestParam={};
	if(''==''&&'session'=='parameter'){
	...
	pageReqeust.containerParam=containerParam_4498;
	pageReqeust.paramsMap=paramsMap;
	pageReqeust.requestParam=requestParam;
	pageReqeust.filter=_filterdata;
	pageReqeust.userIds=getQueryString('empIds');
	pageReqeust.formId=_formId_4498;
	pageReqeust.isView=null;
	pageReqeust.offset=Currentpage*pagesize;;
	pageReqeust.limit=pagesize;;
	if(heightGadedata_4498!=null&&heightGadedata_4498!=undefined){
		pageReqeust.heightGrade = heightGadedata_4498;
	}
	queryParams = JSON.stringify(pageReqeust);
	return queryParams;
}
function grid_ZM_ATT_LEAVE_HIS_fun(pageReqeust){
	var _filterdata={};
	if(document.getElementById('grid_ZM_ATT_LEAVE_HIS_filter')){
	}
	var paramsMap = {};
	var requestParam={};
	if(''==''&&'session'=='parameter'){
	...
	pageReqeust.containerParam=containerParam_4499;
	pageReqeust.paramsMap=paramsMap;
	pageReqeust.requestParam=requestParam;
	pageReqeust.filter=_filterdata;
	pageReqeust.userIds=getQueryString('empIds');
	pageReqeust.formId=_formId_4499;
	pageReqeust.isView=null;
	pageReqeust.offset=Currentpage*pagesize;;
	pageReqeust.limit=pagesize;;
	if(heightGadedata_4499!=null&&heightGadedata_4499!=undefined){
		pageReqeust.heightGrade = heightGadedata_4499;
	}
	queryParams = JSON.stringify(pageReqeust);
	return queryParams;
}
...
var filterParam = {};
	var queryParams;
	function grid_ZM_payemp_LIST11_fun(pageReqeust){
		var _filterdata={};
		if(document.getElementById('grid_ZM_payemp_LIST11_filter')){
		}
		var paramsMap = {};
		var requestParam={};
		if(''==''&&'session'=='parameter'){
		...
		pageReqeust.containerParam=containerParam_4599;
		pageReqeust.paramsMap=paramsMap;
		pageReqeust.requestParam=requestParam;
		pageReqeust.filter=_filterdata;
		pageReqeust.userIds=getQueryString('empIds');
		pageReqeust.formId=_formId_4599;
		pageReqeust.isView=null;
		if(heightGadedata_4599!=null&&heightGadedata_4599!=undefined){
			pageReqeust.heightGrade = heightGadedata_4599;
		}
		queryParams = JSON.stringify(pageReqeust);
		return queryParams;
	}
