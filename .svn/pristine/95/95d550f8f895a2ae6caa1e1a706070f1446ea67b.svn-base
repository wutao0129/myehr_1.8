...
<html>
	...
	<div class="container-fluid">
		<p style="font-size: 35px;font-weight: 900;text-align: center;margin:10px">确认同步数仓</p>
		<div style="margin-left:45%;display:inline-block">
			<a id="a" href="http://127.0.0.1:9875/synchronousOraclePeople" target="_self">确认提交</a>
		</div>
	</div>
