var heightGadedata_3338 =[];
var containerParam_3338 ={};
var GROUPID='';
var XTYPE='';
containerParam_3338 ={};
function changeHeightGadedata_3338(data){
	heightGadedata_3338 = data;
}
$(function() {
    querys_3338();
    querys_3338_1();
...
function grid_SYS_QUESTIONS_choose_fun(pageReqeust){
	...
	if(GROUPID_PARAM==''){
		if(GROUPID==undefined){
			...
			requestParam = {GROUPID:GROUPID+"",XTYPE:XTYPE+""};
		}
	}else{
		requestParam = {GROUPID:GROUPID_PARAM,XTYPE:XTYPE_PARAM};
	}
	pageReqeust.containerParam=containerParam_3338;
	pageReqeust.paramsMap=paramsMap;
	pageReqeust.requestParam=requestParam;
	pageReqeust.filter=_filterdata;
	pageReqeust.userIds=code16;
	pageReqeust.formId=_formId_3338;
	pageReqeust.isView=null;
	if(heightGadedata_3338!=null&&heightGadedata_3338!=undefined){
		pageReqeust.heightGrade = heightGadedata_3338;
	}
	queryParams = JSON.stringify(pageReqeust);
	return queryParams;
}
function grid_SYS_QUESTIONS_choose_fun11_3338(){
	$('#SYS_QUESTIONS_choose_List').bootstrapTable('refresh');
}
function querys_3338() {
            ...
            },
  {
            ...
            onDblClickCell: function (field, value,row,td) {
            	//editSYS_QUESTIONS_choose_click_3338('isView',row);  
            } ,
