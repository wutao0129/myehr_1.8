...
public class SysExamtemplateQuestionCacheCopy implements Serializable {
	 ...
	 * @param columnId
	 */
	public SysExamtemplateQuestionCacheCopy(SysExamtemplateQuestion obj,SysFormCopyCache form) throws Exception{
