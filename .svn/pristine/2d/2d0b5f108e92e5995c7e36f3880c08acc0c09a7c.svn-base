                                    ...
                                    <div style="margin-top:5px;">
                                            ...
                                            <div class="row cell" id="form1" >
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
													<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
														...
														<i style="position:absolute;left:280px;top:10px" onclick="choseColumn()" class="glyphicon glyphicon-plus"></i>
													</div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        ...
                                                        <select id="isFilemanage" title="是否文档管理" styleType="select" name="isFilemanage"  class="form-control" style="width:200px;" textField="dictName" valueField="dictID" DictName="fileManageType" dataField="dicts"></select>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style = "height:40px">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">
                                                        ...
                                                        <textarea id="powerSql" name="powerSql" rows="2" class="form-control" style="width:50%;">
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style = "height:40px">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">
                                                        ...
                                                        <textarea id="orderSql" name="orderSql" rows="2" class="form-control" style="width:50%;">
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style = "height:40px">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">
                                                        ...
                                                        <textarea id="formDefDesc" name="formDefDesc" rows="2" class="form-control" style="width:50%;">
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style = "height:40px">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">
                                                        ...
                                                        <textarea id="formDefInitQzJs" name="formDefInitQzJs" rows="2" class="form-control" style="width:50%;">
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style = "height:40px">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%">
                                                        ...
                                                        <textarea id="formDefInitQzSql" name="formDefInitQzSql" rows="2" class="form-control" style="width:50%;">
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        <div id="form2">
                                            ...
                                            <div class="row cell"  >
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        <lable style="float:left">高分屏显示列数</lable>
                                                        <input id="large_1" name="large_1" type="number" class="form-control" style="width:200px;" />
                                                    </div>
                                                </div>
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        <lable style="float:left">中分屏显示列数</lable>
                                                        <input id="middle_1" name="middle_1" type="number" class="form-control" style="width:200px;" />
                                                    </div>
                                                </div>
												<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        <lable style="float:left">低分屏显示列数</lable>
                                                        <input id="small_1" name="formDefRowCount" type="number" class="form-control" style="width:200px;" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="ui search selection dropdown entitybox field-control" style="display: inline-block;">
                                                        <lable style="float:left">lable宽度</lable>
                                                        <input id="formLableWidth" name="formLableWidth" type="number" class="form-control" style="width:200px;" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
																...
																<div class="row cell" style="border:none;line-height:25px;height:95%;overflow:auto;" >
																	...
																	<div id="columnInfo6" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			...
																			<select id="formColumnGuiType" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"控件类型")%>" styleType="select" name="formColumnGuiType"  class="form-control" style="width:60%;" textField="dictName" valueField="dictID" DictName="SYS_FORM_GUI_TYPE" nullItemText="请选择..." dataField="dict" initParam = "_">
																			</select>
																		</div>
																	</div>
														...
														<div class="tab-pane" id="Tab_2">
															<div id="widgetForm" class="" style="">
																...
																<div id="combobox" class="row cell" style="border:none;line-height:25px;height:95%;overflow:auto;" >
																	...
																	<div id="widgetComboboxInfo18" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"字典名称关联字段")%>: </lable>
																			<input id="comboboxDictNameColumn" name="comboboxDictNameColumnCode" type="text" class="form-control"  vtype="illegalChar;maxLength:255;minLength:null;"  style="width:60%;"/>
																			<i class="glyphicon glyphicon-plus" style="position: absolute;opacity: 0.5;right: 90px;top: 30px;cursor: pointer;" onclick="selectDictNameColumn(this)"></i>
																		</div>
																	</div>
																...
																<div id="fileupload" class="row cell" style="border:none;line-height:25px;display:none;height:95%;overflow:auto;" >
																	...
																	<div id="widgetFileuploadInfo4" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="ui search selection dropdown entitybox field-control" style="display: inline-block;width:100%;">
																			...
																			<input id="fileuploadDataFromType" name="fileuploadDataFromType" type="text" readonly class="form-control" placeholder="选择表单" style="width:60%;float:left"/>
																	...
																	<div id="widgetFileuploadInfo6" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		...
																		<lable style="float:left;font-size:12px"><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"tag包关联下拉")%>: </lable>
																			<input type='text' class="form-control fileiploadlistGuiInitName2" title = "<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"tag包关联下拉")%>"  style="width:60%;float:left" id="fileuploadTagGuiInitName2">
...
function formInit(){
	...
	$.ajax({
		...
		success: function (data) {
			...
			if(data.isFilemanage!=null&&data.isFilemanage!=""){
				$("#isFilemanage").val(data.isFilemanage);
			}else{
				$("#isFilemanage").val("N");
			}
			if(data.isComment!=null&&data.isComment!=""){
				$("#isComment").val(data.isComment);
			}else{
				$("#isComment").val("N");
			}
			if(data.formDefSource!=null&&data.formDefSource!=""){
				$("#formDefSource").val(data.formDefSource);
			}else{
				$("#formDefSource").val("default");
			}
			fileuploadConfig_id = data.fileuploadConfig;
			...
			//$("#formSql").val(data.formDefEntitySql);
			$("#formDefInitQzJs").val(data.formDefInitQzJs);
			$("#formDefInitQzSql").val(data.formDefInitQzSql);
			$("#formLableWidth").val(data.formLableWidth);
			if(data.formDefRowCount!=null){
				$("#large_1").val(data.formDefRowCount.split(",")[0]);
				$("#middle_1").val(data.formDefRowCount.split(",")[1]);
				$("#small_1").val(data.formDefRowCount.split(",")[2]);
			}
			}
		});
}
...
function saveFormInfo(){
	...
	param.formAuthorityIsControl = $("#formAuthorityIsControl").val();
		...
		if(formSql==null||formSql==""){
			param.formDefEntitySql="";
		}else{
		...
		param.formDefRowCount = $("#large_1").val()+","+$("#middle_1").val()+","+$("#small_1").val();
			param.formDefSource =	$("#formDefSource").val();						
		if($("#formDefSource").val()==null||$("#formDefSource").val()==""||$("#formDefSource").val()=="default"){
		param.formDefSource = "";
		}
		
		if(realSql==null||realSql==""||realSql=="default"){
		param.formDefSql = "";
		}else{
			param.formDefSql = realSql;
		}
		param.formLableWidth = $("#formLableWidth").val();
	...
	$.ajax({
		url:'${pageContext.request.contextPath }/form/updataFormParam.action?sign='+sign,
		type:'POST',
		data: JSON.stringify(param),
	    cache: false,
	    contentType: 'application/json;charset=utf-8',
...
function selectDictNameColumn(){
	var url = '/myehr/jsp/form/formcreate/formNameColumnList.jsp?formDefId='+${param.formDefId}+'&type=dictNameColumn';
