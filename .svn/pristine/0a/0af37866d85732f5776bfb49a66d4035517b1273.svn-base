var heightGadedata_3337 =[];
var containerParam_3337 ={};
containerParam_3337 ={};
var GROUPID='';
function changeHeightGadedata_3337(data){
	heightGadedata_3337 = data;
}
$(function() {
    querys_3337();
    querys_3337_1();
...
function grid_SYS_QUESTIONS_choose_fun(pageReqeust){
	...
	if(GROUPID_PARAM==''){
		if(GROUPID==undefined){
			requestParam = {GROUPID:GROUPID_PARAM};
		}else{
			requestParam = {GROUPID:XTYPE+""};
		}
	}else{
		requestParam = {GROUPID:GROUPID_PARAM};
	}
	pageReqeust.containerParam=containerParam_3337;
	pageReqeust.paramsMap=paramsMap;
	pageReqeust.requestParam=requestParam;
	pageReqeust.filter=_filterdata;
	pageReqeust.userIds=code16;
	pageReqeust.formId=_formId_3337;
	pageReqeust.isView=null;
	if(heightGadedata_3337!=null&&heightGadedata_3337!=undefined){
		pageReqeust.heightGrade = heightGadedata_3337;
	}
	queryParams = JSON.stringify(pageReqeust);
	return queryParams;
}
function grid_SYS_QUESTIONS_choose_fun11_3337(){
	$('#SYS_QUESTIONS_choose_List').bootstrapTable('refresh');
}
function grid_SYS_QUESTIONS_choose_HeighQuery_3337() {
	layer.open({
		type: 2,
		showMaxButton: true,
		title:code13 ,
		area: ['855', '500'],
		maxmin: true,
		content:'/myehr/jsp/form/button/heightGrade.jsp?formFunction=grid_SYS_QUESTIONS_choose_fun11_3337&formDefId=3337&formDefLayout=2',
...
function querys_3337() {
            ...
            },
  {
            ...
            onDblClickCell: function (field, value,row,td) {
            	//editSYS_QUESTIONS_choose_click_3337('isView',row);  
            } ,
