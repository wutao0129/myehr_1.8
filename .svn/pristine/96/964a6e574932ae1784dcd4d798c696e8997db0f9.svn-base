...
<html>
<link rel="stylesheet" href="/myehr/common/css/commomcss.css" type="text/css"></link>
...
<link rel="icon" type="image/x-icon" href="/myehr/jsp/orgpicture/dabengOrgChart/myorg/img/logo.ico">
<script type="text/javascript" src="/myehr/common/js/commonjs.js"></script>
...
<div class="input-group" style="z-index: 5;float:right">
    <div id="grid_ORG_COMP_CARD_filter">
        <table class="cbs-table" style="width:100%">
             <tr>
				<td style="padding-left:10px;"  width="100"  >				<label style="float:left;font-size:12px;width:100;line-height:25px">机构类型: </label></td>
				<td style="padding-left:10px;"  width="100"  align="left"  >						<select id="FILTER_ORG_COMPANY.ORGCOMPANY_COMPTYPE_672" title="机构类型" columnId="20727" styleType="select" name="ORGCOMPANY_COMPTYPE"  class="form-control " emptyText="请选择..."  style="float:left;" textField="dictName" valueField="dictID" DictName="COMPTYPE" dataField1 = "dict"  dataField="dictList_form_20727"></select><span style='color:red;line-height:35px;font-size:27px'></span>
</td>
			<td style="float:right;padding-top:5px">
				<input id="FILTER_672" name="FILTER_672" placeholder="机构名称,机构编码" style="padding: 6px 30px 6px 10px;min-height:24px;font-size:12px" title="机构名称,机构编码" type="text" class="form-control" oninput="grid_ORG_COMP_CARD_fun11_672()" />
...
<i class="glyphicon glyphicon-search" style="position: absolute;right: 12px;top: 6px;cursor: pointer;color:#fff">
		...
		<div class="BTNGROUP BTNGROUP_672" style="margin:5px auto; display:inline-block;height: 30px;z-index: 6;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editORG_COMP_CARD"  class="btn btn-warning" value=详情 onclick="editORG_COMP_CARD_click_672()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="edit2ORG_COMP_CARD"  class="btn btn-warning" value=机构证件 onclick="edit2ORG_COMP_CARD_click_672()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="edit3ORG_COMP_CARD"  class="btn btn-warning" value=机构管理历史 onclick="edit3ORG_COMP_CARD_click_672()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="exportORG_COMP_CARD"  class="btn btn-primary" value=导出 onclick="exportORG_COMP_CARD_click_672()"/>
			    <a id="export_6128" href="/myehr/form/getExportFile.action?buttonId=6128" type="hidden" value=""></a>
			    <a id="exportBig_6128" href="/myehr/form/getExportBigFile.action?buttonId=6128" type="hidden" value=""></a>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="executeSQLORG_COMP_CARD"  class="btn btn-success" value=删除 onclick="executeSQLORG_COMP_CARD_click_672()"/>
			</div>
		</div>
...
<div class="input-group" style="z-index: 5;float:right">
    <div id="grid_ORG_COMPADD_LIST_filter">
        <table class="cbs-table" style="width:100%">
             <tr>
			<td style="float:right;padding-top:5px">
				<input id="FILTER_676" name="FILTER_676" placeholder="机构编码,机构名称" style="padding: 6px 30px 6px 10px;min-height:24px;font-size:12px" title="机构编码,机构名称" type="text" class="form-control" oninput="grid_ORG_COMPADD_LIST_fun11_676()" />
				<i class="icon-search" style="position: absolute;right: 12px;top: 2px;cursor: pointer;"></i>
			</td>
            </tr>
        </table>
		...
		<div class="BTNGROUP BTNGROUP_676" style="margin:5px auto; display:inline-block;height: 30px;z-index: 6;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="addORG_COMPADD_LIST"  class="btn btn-primary" value=增加 onclick="addORG_COMPADD_LIST_click_676()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editORG_COMPADD_LIST"  class="btn btn-warning" value=修改 onclick="editORG_COMPADD_LIST_click_676()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="removeORG_COMPADD_LIST"  class="btn btn-danger" value=删除 onclick="removeORG_COMPADD_LIST_click_676()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="executeSQLORG_COMPADD_LIST"  class="btn btn-success" value=生效 onclick="executeSQLORG_COMPADD_LIST_click_676()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="importORG_COMPADD_LIST"  class="btn btn-info" value=导入 onclick="importORG_COMPADD_LIST_click_676()"/>
			</div>
		</div>
...
<div class="input-group" style="z-index: 5;float:right">
    <div id="grid_ORG_COMPEDIT_LIST_filter">
        <table class="cbs-table" style="width:100%">
             <tr>
			<td style="float:right;padding-top:5px">
				<input id="FILTER_679" name="FILTER_679" placeholder="机构编码,机构名称" style="padding: 6px 30px 6px 10px;min-height:24px;font-size:12px" title="机构编码,机构名称" type="text" class="form-control" oninput="grid_ORG_COMPEDIT_LIST_fun11_679()" />
				<i class="icon-search" style="position: absolute;right: 12px;top: 2px;cursor: pointer;"></i>
			</td>
            </tr>
        </table>
		...
		<div class="BTNGROUP BTNGROUP_679" style="margin:5px auto; display:inline-block;height: 30px;z-index: 6;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="introduceORG_COMPEDIT_LIST"  class="btn btn-primary" value=引入 onclick="introduceORG_COMPEDIT_LIST_click_679()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editORG_COMPEDIT_LIST"  class="btn btn-warning" value=修改 onclick="editORG_COMPEDIT_LIST_click_679()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="removeORG_COMPEDIT_LIST"  class="btn btn-danger" value=删除 onclick="removeORG_COMPEDIT_LIST_click_679()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="executeSQLORG_COMPEDIT_LIST"  class="btn btn-success" value=生效 onclick="executeSQLORG_COMPEDIT_LIST_click_679()"/>
			</div>
		</div>
...
<div class="input-group" style="z-index: 5;float:right">
    <div id="grid_ORG_COMPDIS_LIST_filter">
        <table class="cbs-table" style="width:100%">
             <tr>
			<td style="float:right;padding-top:5px">
				<input id="FILTER_682" name="FILTER_682" placeholder="机构编码,机构名称" style="padding: 6px 30px 6px 10px;min-height:24px;font-size:12px" title="机构编码,机构名称" type="text" class="form-control" oninput="grid_ORG_COMPDIS_LIST_fun11_682()" />
				<i class="icon-search" style="position: absolute;right: 12px;top: 2px;cursor: pointer;"></i>
			</td>
            </tr>
        </table>
		...
		<div class="BTNGROUP BTNGROUP_682" style="margin:5px auto; display:inline-block;height: 30px;z-index: 6;">
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="introduceORG_COMPDIS_LIST"  class="btn btn-primary" value=引入 onclick="introduceORG_COMPDIS_LIST_click_682()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="editORG_COMPDIS_LIST"  class="btn btn-warning" value=修改 onclick="editORG_COMPDIS_LIST_click_682()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="removeORG_COMPDIS_LIST"  class="btn btn-danger" value=删除 onclick="removeORG_COMPDIS_LIST_click_682()"/>
			</div>
			<div style="margin-right:10px;display:inline-block">
			    <input type="button" id="executeSQLORG_COMPDIS_LIST"  class="btn btn-success" value=生效 onclick="executeSQLORG_COMPDIS_LIST_click_682()"/>
			</div>
		</div>
...
<script type="text/javascript" src="/myehr/jsp/formbuild/org_manage/org_compan/org_companyInfo/org_compMutil_list.js"></script>
<script>
...
function edit3ORG_COMP_CARD_click_672(isView,data){
	...
	function exportData_672(fieldArray){
		...
		var url='/myehr/form/exportCardformInitData.action';
		$.ajax({
		    url:url,
		    type:'post',
		    data: _filterdata,
