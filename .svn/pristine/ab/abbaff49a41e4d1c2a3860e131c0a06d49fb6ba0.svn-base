...
%>
<link rel="stylesheet" href="${pageContext.request.contextPath }/common/css/commomcss.css" type="text/css"></link>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/common/js/commonjs.js"></script>
