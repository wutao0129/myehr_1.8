        ...
        $("#emp_emp_list_List").bootstrapTable({
                ...
                formatter: function (value, row, index) {
                    if(value==undefined){
                        value='-';
                    	  ...
                    	  return "<a  class=\"eli w\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_EMPCODE\" onmouseover=\"editemp_emp_list_click_2131('isView');\" data-type=\"text\" data-pk=\""+row.Id+"\" data-title=\"工号\">"+value+"</a>";
                }
            },
            {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    value = (value+'').replace(/ /g,'');
                    return "<a class=\"eli wpx\" style=\"font-size:12px;text-decoration:none;color:black;width:200px;\" name=\"EMPVEMPLOYEE_COUNTRY\" data-type=\"select\" data-pk=\""+row.Id+"\" data-value=\""+value+"\" data-title=\"国籍\" data-source=\"${pageContext.request.contextPath }/dict/searchSysDictEntryTypeCode1.action?deleteMark=emp_COUNTRY&realValue="+value+"+\"></a>";
                }
            },
