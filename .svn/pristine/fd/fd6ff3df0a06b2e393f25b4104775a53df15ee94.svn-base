		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center"></h3>
			...
			<tr style="height:65px" id="tr2">
				...
				<td style="padding-left:10px;"  align="left" width="20%"  >
					...
					<input id="SYS_ICON.buttonFormName" name="buttonFormName" type="text" value="formName" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;position:absolute"/><i id="formAddIcon" style="position:relative;left:180px;top:5px" onclick="choseForm()" class="glyphicon glyphicon-plus"></i>
				</td>
    ...
    function changeeSlect2(obj){
    	...
    	if(buttonAddType=='addUrl'){
    		if(obj.value=='default'){
				...
				document.getElementById('formAddIcon').style.display='block';
				...
				document.getElementById('formAddIcon').style.display='none';
    		}
    	}else{
    		if(obj.value=='fun'){
				$("#tr2").hide();
