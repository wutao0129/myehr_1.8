...
<div class="container-fluid">
	<div style="margin-top:5px;">
		<input id="SYS_SYSTEM_SCHEME.datepickerFormColumnId" name="datepickerFormColumnId" type="hidden" class="form-control"  style="width:200px;"/>
		<input id="SYS_SYSTEM_SCHEME.datepickerId" name="datepickerId" type="hidden" class="form-control"  style="width:200px;"/>
		...
		<h3 style=" background:#FFF;color:blue; display:block;font-size:12;position:absolute; left:10px; top:-27px;text-align:center"></h3>
			...
			<tr style="height:65px">
				...
				<td style="padding-left:10px;"  align="left"  ><select id="SYS_SYSTEM_SCHEME.datepickerDataFromType" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"初始值来源类型")%>" name="datepickerDataFromType"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_FORM_INIT_DATA_TYPE" nullItemText="" dataField="dicts"></select></td>
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"初始值来源")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><input id="SYS_SYSTEM_SCHEME.datepickerDataFromValue" name="datepickerDataFromValue" type="text" class="form-control"  vtype="illegalChar;maxLength:null;minLength:null;" style="width:200px;"/></td>
			</tr>
			<tr style="height:65px">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"日期格式")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><select id="SYS_SYSTEM_SCHEME.datepickerFormat" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"日期格式")%>" name="datepickerFormat"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_FORM_DATEFORMAT" nullItemText="" dataField="dicts"></select></td>
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"时间格式")%>: </lable></td>
				<td style="padding-left:10px;"  align="left"  ><select id="SYS_SYSTEM_SCHEME.datepickerTimeformat" title="<%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"时间格式")%>" name="datepickerTimeformat"  class="form-control" emptyText="请选择..."  required="true"  style="width:200px;" textField="dictName" valueField="dictID" DictName="SYS_FORM_TIMEFORMAT" nullItemText="" dataField="dicts"></select></td>
			</tr>
			<tr style="height:65px">
				<td ><input  id="SYS_SYSTEM_SCHEME.datepickerAllowinput"  name="datepickerAllowinput" type="checkbox" value="1"/><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"允许输入")%></td>
				<td ><input  id="SYS_SYSTEM_SCHEME.datepickerShowtime"  name="datepickerShowtime" type="checkbox" value="1"/><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"显示'时间输入框'")%></td>
				<td ><input  id="SYS_SYSTEM_SCHEME.datepickerShowokbutton"  name="datepickerShowokbutton" type="checkbox" value="1"/><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"显示'确定'按钮")%></td>
				<td ><input  id="SYS_SYSTEM_SCHEME.datepickerShowclearbutton"  name="datepickerShowclearbutton" type="checkbox" value="1"/><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"显示'清除'按钮")%></td>
				<td ><input  id="SYS_SYSTEM_SCHEME.datepickerShowtodaybutton"  name="datepickerShowtodaybutton" type="checkbox" value="1"/><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"显示'今天'按钮")%></td>
			</tr>
			<tr id="tr5">
		        ...
		        <td colspan="3" align="left">
		        	<textarea  id="SYS_SYSTEM_SCHEME.datepickerValuechangeFun" name="datepickerValuechangeFun"  class="form-control"  rows="5"  style="width:400;margin-bottom:5px"> </textarea>
		   		</td>
	      	</tr>
	      	<tr id="tr6">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"点击事件方案")%>：</lable></td>
		        <td colspan="3" align="left">
		        	<textarea  id="SYS_SYSTEM_SCHEME.datepickerClickFun" name="datepickerClickFun"  class="form-control"  rows="5"  style="width:400;margin-bottom:5px"> </textarea>
		   		</td>
	      	</tr>
			<tr id="tr7">
				<td style="padding-left:10px;"  width="150"  ><lable><%=LangUtil.getLangByCode((String)session.getAttribute("langType"),"自定义绘制方案")%>：</lable></td>
		        <td colspan="3" align="left">
		        	<textarea  id="SYS_SYSTEM_SCHEME.datepickerDrawdateFun" name="datepickerDrawdateFun"  class="form-control"  rows="5"  style="width:400;margin-bottom:5px"> </textarea>
		   		</td>
	      	</tr>
		</table>
	</div>
...
$(function () {  
	...
	window.onload=function(){
		...
		document.getElementById("SYS_SYSTEM_SCHEME.datepickerFormColumnId").value="${param.sqlParamsId}";
	...
	function save_formemp_emp_edit_click_1881(){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/param/saveDatepickerInfoParams.action',
			type:'post',
	...
	function _initData(pkId){
		...
		$.ajax({
			url:'${pageContext.request.contextPath }/param/queryDatepickerInfoParamsById.action?sqlParamsId='+sqlParamsId,
			type:'post',
			//data: JSON.stringify(_param),
			cache: false,
			contentType: 'application/json;charset=utf-8',
