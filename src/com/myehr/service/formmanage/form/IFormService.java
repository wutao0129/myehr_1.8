...
public interface IFormService {
	...
	void buildNewChartForm(SysFormconfigCache aa, SysRequestParam param);

	boolean isCreateForm(SysFormconfigCache formCache);

	void createGridVue(SysFormconfigCache formCache, HttpServletRequest request);

	void buildFreeActForm2_Grid(SysFormconfigCache form,
			SysRequestParam request, String isApp,
			ActNodePropertiesExpand actNodePropertiesExpand, String nodeId,
			String taskId, String isApp2);

	void buildFreeActForm_Grid(SysFormconfigCache form,
			SysRequestParam request, String isApp,
			ActNodePropertiesExpand actNodePropertiesExpand, String nodeId,
			String taskId, String isApp2);

	void createCardVue(SysFormconfigCache formCache, HttpServletRequest request);

	void createCCYFormVue(SysFormconfigCache formCache,
			HttpServletRequest request);

	void createCCSFormVue(SysFormconfigCache formCache,
			HttpServletRequest request);
}
