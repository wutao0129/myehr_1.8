...
import com.myehr.common.utils.Variable;
...
//	private String procExecUrl; 	// 流程执行（办理）RUL
	...
	private String createrPhoto; // 发起人头像
	
	private String assignee; // 任务执行人编号
	private String assigneeName; // 任务执行人名称
	
	private String prevAssignee; // 上一个任务执行人编号
	private String prevAssigneeName; // 上一个任务执行人名称
	private String createAgo;//任务到达距今时间
...
//	private Variable taskVars; 	// 流程任务变量
	...
	private String isViewProcessPicture; // 是否查看流程图
	
	private String isAllowBatchApprove; // 是否允许批量审批
	
	private String isFreeAction;
	
	private Date actCreateTime; // 任务到达时间
	
	private Date actEndTime; // 任务完成时间
	...
	public String getPrevAssigneeName() {
		return prevAssigneeName;
	}

	public void setPrevAssigneeName(String prevAssigneeName) {
		this.prevAssigneeName = prevAssigneeName;
	}

	public String getCreateAgo() {
		return createAgo;
	}

	public void setCreateAgo(String createAgo) {
		this.createAgo = createAgo;
	}
	...
	public String getIsFreeAction() {
		return isFreeAction;
	}

	public void setIsFreeAction(String isFreeAction) {
	...
	public void setIsAllowBatchApprove(String isAllowBatchApprove) {
		this.isAllowBatchApprove = isAllowBatchApprove;
	}

	public String getIsViewProcessPicture() {
		return isViewProcessPicture;
	}

	public void setIsViewProcessPicture(String isViewProcessPicture) {
		this.isViewProcessPicture = isViewProcessPicture;
	}
...
//	}
	...
	public String getDurationTime(){
		if (histIns!=null && histIns.getDurationInMillis() != null){
			return histIns.getDurationInMillis().toString();
		}
		return "";
	}
