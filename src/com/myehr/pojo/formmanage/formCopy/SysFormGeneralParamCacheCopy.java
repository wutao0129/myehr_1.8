...
public class SysFormGeneralParamCacheCopy implements Serializable {
	...
	public SysFormGeneralParamCacheCopy(){}
	
	/**
	 * * 构造函数 通过DataObject加载对象
	 * @param obj
	 */
	public SysFormGeneralParamCacheCopy(SysFormGeneralParam obj) {
		this.pojo = obj;
