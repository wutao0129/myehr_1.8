...
public class SysFormGeneralExecSqlCache implements Serializable {
	private static Logger logger = LoggerFactory.getLogger(SysFormGeneralExecSqlCache.class);
	/**
	 * 
	 */
	...
	public SysFormGeneralExecSqlCache(String buttonExecSqlType, String buttonId) {
	 ...
	 * @param exeSqlId
	 */
	public SysFormGeneralExecSqlCache(long exeSqlId) {
		IButtonService service = (IButtonService)SpringContextUtils.getBeanById("IButtonService");
	...
	public SysFormGeneralExecSqlCache(SysExecSql obj) {
		if(obj!=null){
			this.setThisByDataObject(obj);
		}
	}
	
	public SysFormGeneralExecSqlCache() {
		// TODO Auto-generated constructor stub
	}


	public void setPojo(SysExecSql pojo) {
		this.pojo = pojo;
	}
	...
	public static String getCardParamsJsStr(List<String[]> params1 ,SysFormconfigCache form,SysRequestParam request,boolean isFilter){
		...
		for(String[] param : params1){
			...
			}else if("a".equals(param[0])){
				String str = param[1];
				String str2 = SysCardFormBeansUtil.getNbsp(2) + "'a_" + param[1] + "' : '" + param[1] + "',\n";
				jsParams += str2;
			}
		}
		if(jsParams.endsWith(",\n")){
