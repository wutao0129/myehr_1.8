...
//		return DatabaseExt.getNextSequence(keyName);
	 ...
	 */
	public static void setCommonInfo(Map dataObject, String deleteMark) {
//		dataObject.put("operatorName", getUserId());
...
//		}
	 ...
	 * @param dataObject 数据对象
	 */
	public static void setCommonInfo(Map dataObject) {
...
//		return user.getUserRemoteIP();
	 ...
	 * @param deleteMark 删除标识
	 */
	public static void setCommonInfo(List<Map> dataObjects,String deleteMark){
		if (dataObjects != null && dataObjects.size() > 0) {
			for (int i = 0; i < dataObjects.size(); i++) {
				setCommonInfo(dataObjects.get(i), deleteMark);
			}
		}
	}
